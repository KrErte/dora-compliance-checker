        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a routerLink="/nis2/scope-check"
              ...
              <span class="text-sm text-slate-300 group-hover:text-amber-300">{{ lang.t('notfound.nis2_scope') }}</span>
            </a>
            <a routerLink="/assessment"
              ...
              <span class="text-sm text-slate-300 group-hover:text-emerald-300">{{ lang.t('notfound.dora_assessment') }}</span>
            </a>
            <a routerLink="/board-risk"
              ...
              <span class="text-sm text-slate-300 group-hover:text-teal-300">{{ lang.t('notfound.board_risk') }}</span>
            </a>
            <a routerLink="/pricing"
              ...
              <span class="text-sm text-slate-300 group-hover:text-violet-300">{{ lang.t('nav.pricing') }}</span>
            </a>
          </div>
        </div>
