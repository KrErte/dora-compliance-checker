      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
          ...
          <div *ngIf="success" class="text-center space-y-4">
            ...
            <p class="text-sm text-emerald-300">{{ lang.t('auth.forgot_password_success') }}</p>
            <a routerLink="/login"
          ...
          <form *ngIf="!success" (ngSubmit)="onSubmit()">
            ...
            <div class="mb-6">
              <label for="reset-email" class="block text-sm font-medium text-slate-300 mb-2">{{ lang.t('auth.email') }}</label>
