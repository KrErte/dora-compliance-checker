  ...
  template: `
    <div class="max-w-4xl mx-auto animate-fade-in-up">
      ...
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.general_title') }}</h2>
        <div class="text-slate-600 text-sm space-y-3">
          <p><span class="text-slate-600">{{ lang.t('terms.provider') }}:</span> DoraAudit.eu</p>
          <p><span class="text-slate-600">{{ lang.t('terms.operator') }}:</span> Doraaudit</p>
          <p class="text-slate-600">{{ lang.t('terms.service_desc') }}</p>
          <p class="text-slate-400 mt-4 p-3 bg-white rounded-lg border border-slate-200">
      ...
      <!-- C) User Account -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.account_title') }}</h2>
        ...
        <div class="space-y-4">
          ...
          <div class="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div class="flex items-center gap-2 mb-2">
              ...
              <span class="text-blue-600 font-medium text-sm">{{ lang.t('terms.refund_title') }}</span>
            </div>
            <p class="text-slate-600 text-sm">{{ lang.t('terms.refund_desc') }}</p>
            <p class="text-slate-400 text-xs mt-2">{{ lang.t('terms.refund_contact') }}: <a href="mailto:info@doraaudit.eu" class="text-blue-600 hover:text-blue-500">info&#64;doraaudit.eu</a></p>
          </div>
        </div>
      </div>
      ...
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.ip_title') }}</h2>
        <ul class="text-slate-600 text-sm space-y-3">
          <li class="flex items-start gap-2">
            <span class="text-blue-600 mt-1">•</span>
      ...
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.availability_title') }}</h2>
        <ul class="text-slate-600 text-sm space-y-3">
          <li class="flex items-start gap-2">
            <span class="text-blue-600 mt-1">•</span>
      ...
      <!-- H) Termination -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.termination_title') }}</h2>
        <ul class="text-slate-600 text-sm space-y-3">
          <li class="flex items-start gap-2">
            <span class="text-blue-600 mt-1">•</span>
      ...
      <!-- J) Contact -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-600 mb-4">{{ lang.t('terms.contact_title') }}</h2>
        <p class="text-slate-600 text-sm">
          {{ lang.t('terms.contact_desc') }}
          <a href="mailto:info@doraaudit.eu" class="text-blue-600 hover:text-blue-500 ml-1">info&#64;doraaudit.eu</a>
        </p>
      </div>
