...
@Component({
  ...
  template: `
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <!-- Empty state -->
      <div *ngIf="!loading && negotiations.length === 0" class="bg-white border border-slate-200 rounded-2xl p-12 text-center">
        ...
        <a routerLink="/contract-analysis"
           class="inline-block px-6 py-2.5 rounded-xl bg-blue-600 text-white font-semibold text-sm">
