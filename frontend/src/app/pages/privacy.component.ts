    ...
    <div class="max-w-4xl mx-auto animate-fade-in-up">
      ...
      <div class="glass-card p-6 mb-6">
        ...
        <div class="text-slate-300 text-sm space-y-2">
          ...
          <p><span class="text-slate-400">{{ lang.t('privacy.controller_operator') }}:</span> ComplianceHub OÜ</p>
      ...
      <!-- 2. Data collected -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.data_title') }}</h2>
      ...
      <!-- 3. Legal basis -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.legal_title') }}</h2>
        <p class="text-slate-400 text-sm mb-4">{{ lang.t('privacy.legal_intro') }}</p>

        <ul class="text-slate-300 text-sm space-y-3">
          <li class="flex items-start gap-3">
            <span class="text-emerald-400 font-mono text-xs bg-emerald-400/10 px-2 py-1 rounded">Art. 6(1)(b)</span>
            <span>{{ lang.t('privacy.legal_contract') }}</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-emerald-400 font-mono text-xs bg-emerald-400/10 px-2 py-1 rounded">Art. 6(1)(f)</span>
            <span>{{ lang.t('privacy.legal_interest') }}</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-emerald-400 font-mono text-xs bg-emerald-400/10 px-2 py-1 rounded">Art. 6(1)(a)</span>
      ...
      <!-- 4. Data retention -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.retention_title') }}</h2>

        <div class="grid gap-3">
          <div class="flex justify-between items-center py-2 border-b border-slate-700/50">
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.retention_account') }}</span>
            <span class="text-emerald-400 text-sm font-medium">{{ lang.t('privacy.retention_account_period') }}</span>
          </div>
          <div class="flex justify-between items-center py-2 border-b border-slate-700/50">
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.retention_assessment') }}</span>
            <span class="text-emerald-400 text-sm font-medium">{{ lang.t('privacy.retention_assessment_period') }}</span>
          </div>
          <div class="flex justify-between items-center py-2 border-b border-slate-700/50">
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.retention_payment') }}</span>
            <span class="text-emerald-400 text-sm font-medium">{{ lang.t('privacy.retention_payment_period') }}</span>
          </div>
          <div class="flex justify-between items-center py-2">
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.retention_logs') }}</span>
            <span class="text-emerald-400 text-sm font-medium">{{ lang.t('privacy.retention_logs_period') }}</span>
          </div>
        </div>
      </div>
      ...
      <!-- 5. Third parties -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.third_title') }}</h2>
      ...
      <!-- 6. Rights -->
      <div class="glass-card p-6 mb-6 border-emerald-500/20 bg-gradient-to-br from-emerald-500/5 to-teal-500/5">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.rights_title') }}</h2>
        <p class="text-slate-400 text-sm mb-4">{{ lang.t('privacy.rights_intro') }}</p>

        <div class="grid sm:grid-cols-2 gap-3">
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 15</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_access') }}</span>
          </div>
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 16</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_rectification') }}</span>
          </div>
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 17</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_erasure') }}</span>
          </div>
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 18</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_restriction') }}</span>
          </div>
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 20</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_portability') }}</span>
          </div>
          <div class="flex items-start gap-2">
            <span class="text-emerald-400 font-mono text-xs">Art. 21</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.right_objection') }}</span>
          </div>
        </div>

        <div class="mt-4 p-3 bg-slate-800/50 rounded-lg">
          <p class="text-slate-300 text-sm">{{ lang.t('privacy.rights_contact') }} <a href="mailto:info@doraaudit.eu" class="text-emerald-400 hover:text-emerald-300">info&#64;doraaudit.eu</a></p>
      ...
      <!-- 7. Cookies -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.cookies_title') }}</h2>

        <div class="space-y-3">
          <div class="flex items-center gap-3 p-3 bg-slate-800/30 rounded-lg">
            <span class="text-xs px-2 py-1 rounded bg-emerald-400/20 text-emerald-400">{{ lang.t('privacy.cookies_required') }}</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.cookies_functional') }}</span>
          </div>
          <div class="flex items-center gap-3 p-3 bg-slate-800/30 rounded-lg">
            <span class="text-xs px-2 py-1 rounded bg-amber-400/20 text-amber-400">{{ lang.t('privacy.cookies_optional') }}</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.cookies_analytics') }}</span>
          </div>
          <div class="flex items-center gap-3 p-3 bg-slate-800/30 rounded-lg">
            <span class="text-xs px-2 py-1 rounded bg-slate-400/20 text-slate-400">{{ lang.t('privacy.cookies_none') }}</span>
            <span class="text-slate-300 text-sm">{{ lang.t('privacy.cookies_marketing') }}</span>
          </div>
        </div>
      </div>
      ...
      <!-- 8. Security -->
      <div class="glass-card p-6 mb-6">
        <h2 class="text-xl font-semibold text-emerald-400 mb-4">{{ lang.t('privacy.security_title') }}</h2>
