      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
          <a routerLink="/guardian/alerts"
             class="px-4 py-2 rounded-xl bg-slate-100 border border-slate-200 text-slate-600 text-sm hover:bg-slate-100 transition-all flex items-center gap-2">
          ...
          <div class="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2 mb-1">
                <h3 class="text-slate-900 font-semibold truncate">{{ contract.contractName }}</h3>
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
              ...
              <a *ngIf="contract.lastAnalysisId" [routerLink]="['/contract-results', contract.lastAnalysisId]"
                 class="px-3 py-1.5 rounded-lg text-xs font-medium bg-slate-700/50 text-slate-600 border border-slate-300/30 hover:bg-slate-100 transition-all">
