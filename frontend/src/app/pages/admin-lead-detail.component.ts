  ...
  template: `
    <div class="max-w-4xl mx-auto">
      ...
      <div class="flex items-center gap-4 mb-6">
        <button (click)="goBack()" class="p-2 text-slate-400 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
        </button>
        <div class="flex-1">
          <h1 class="text-2xl font-bold text-slate-900">{{ lead()?.companyName || 'Loading...' }}</h1>
          ...
          <div class="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" [(ngModel)]="edit.companyName" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Registry Code</label>
                <input type="text" [(ngModel)]="edit.registryCode" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Country</label>
                <select [(ngModel)]="edit.country" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none cursor-pointer">
              ...
              <div>
                ...
                <select [(ngModel)]="edit.licenseType" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none cursor-pointer">
                  <option value="">—</option>
              ...
              <div>
                ...
                <select [(ngModel)]="edit.sector" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none cursor-pointer">
                  <option value="">—</option>
              ...
              <div>
                ...
                <select [(ngModel)]="edit.companySize" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none cursor-pointer">
              ...
              <div>
                ...
                <input type="url" [(ngModel)]="edit.website" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Email</label>
                <input type="email" [(ngModel)]="edit.email" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Phone</label>
                <input type="text" [(ngModel)]="edit.phone" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">City</label>
                <input type="text" [(ngModel)]="edit.city" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div class="md:col-span-2">
                <label class="block text-xs text-slate-500 mb-1">Address</label>
                <input type="text" [(ngModel)]="edit.address" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div class="md:col-span-2">
                <label class="block text-xs text-slate-500 mb-1">LinkedIn Company URL</label>
                <input type="url" [(ngModel)]="edit.linkedinUrl" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
            </div>
            ...
            <div class="flex items-center gap-6 mt-4 pt-4 border-t border-slate-200">
              <label class="flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
                <input type="checkbox" [(ngModel)]="edit.doraApplicable" class="rounded bg-white border-slate-300 text-blue-600 focus:ring-blue-500" />
                DORA Applicable
              </label>
              <label class="flex items-center gap-2 text-sm text-slate-600 cursor-pointer">
                <input type="checkbox" [(ngModel)]="edit.nis2Applicable" class="rounded bg-white border-slate-300 text-blue-600 focus:ring-blue-500" />
                NIS2 Applicable
              </label>
            </div>
          </div>
          ...
          <div class="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" [(ngModel)]="edit.ctoName" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">CTO LinkedIn</label>
                <input type="url" [(ngModel)]="edit.ctoLinkedin" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Compliance Officer Name</label>
                <input type="text" [(ngModel)]="edit.complianceOfficerName" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div>
                <label class="block text-xs text-slate-500 mb-1">Compliance Officer LinkedIn</label>
                <input type="url" [(ngModel)]="edit.complianceOfficerLinkedin" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
            </div>
          </div>
          ...
          <div class="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select [(ngModel)]="edit.leadStatus" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none cursor-pointer">
              ...
              <div>
                ...
                <input type="date" [(ngModel)]="editLastContactedDate" class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none" />
              </div>
              <div class="md:col-span-2">
                <label class="block text-xs text-slate-500 mb-1">Notes</label>
                <textarea [(ngModel)]="edit.notes" rows="4"
                          class="w-full bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-2 focus:border-blue-500 focus:outline-none resize-none"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white border border-blue-200 rounded-xl p-6">
            ...
            <div class="flex items-center gap-4 mb-4">
              ...
              <button (click)="outreachLang.set('ET')" class="px-3 py-1 text-xs rounded-lg transition-colors"
                      [class]="outreachLang() === 'ET' ? 'bg-blue-700 text-white' : 'bg-white text-slate-400 hover:text-slate-900'">
                Estonian
              </button>
              <button (click)="outreachLang.set('EN')" class="px-3 py-1 text-xs rounded-lg transition-colors"
                      [class]="outreachLang() === 'EN' ? 'bg-blue-700 text-white' : 'bg-white text-slate-400 hover:text-slate-900'">
                English
              </button>
              ...
              <input type="text" [ngModel]="outreachName()" (ngModelChange)="outreachName.set($event)" placeholder="Name"
                     class="w-40 bg-white border border-slate-300 text-slate-700 text-sm rounded-lg px-3 py-1.5 focus:border-blue-500 focus:outline-none" />
            </div>
            ...
            <div class="bg-white rounded-lg p-4 font-mono text-sm text-slate-600 relative">
              ...
              <div class="absolute top-2 right-2 flex items-center gap-2">
                ...
                <button (click)="copyMessage()" class="px-2 py-1 text-xs bg-slate-100 hover:bg-slate-50 text-slate-600 rounded transition-colors">
                  {{ copied() ? 'Copied!' : 'Copy' }}
                </button>
              </div>
            </div>
