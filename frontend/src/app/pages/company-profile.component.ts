        ...
        <div *ngIf="searchResults().length > 0" class="max-w-lg mx-auto">
          <div class="glass-card divide-y divide-slate-700/50">
            <button *ngFor="let result of searchResults()"
              ...
              <div>
                <p class="text-white font-medium group-hover:text-blue-600 transition-colors">{{ result.name }}</p>
        ...
        <div class="mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <button *ngFor="let company of fiLicensedCompanies().slice(0, 12)"
              ...
              <p class="text-white font-medium text-sm group-hover:text-blue-600 transition-colors truncate">{{ company.name }}</p>
      ...
      <div *ngIf="selectedProfile()" class="space-y-6">
        ...
        <div class="flex items-start justify-between">
          ...
          <div class="flex items-center gap-3">
            ...
            <button (click)="refreshProfile()" [disabled]="isRefreshing()"
                    class="p-2 rounded-lg bg-slate-700/50 text-slate-400 hover:text-blue-600 hover:bg-slate-700 transition-all disabled:opacity-50">
        ...
        <div class="glass-card p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a routerLink="/contract-analysis" class="flex items-center gap-4 p-4 bg-slate-800/30 rounded-lg hover:bg-white transition-colors group">
              ...
              <div>
                <p class="text-white font-medium group-hover:text-blue-600 transition-colors">{{ lang.t('company.cta_contracts') }}</p>
                <p class="text-xs text-slate-500">{{ lang.t('company.cta_contracts_desc') }}</p>
              </div>
            </a>
            <a routerLink="/assessment" class="flex items-center gap-4 p-4 bg-slate-800/30 rounded-lg hover:bg-white transition-colors group">
              ...
              <div>
                <p class="text-white font-medium group-hover:text-blue-500 transition-colors">{{ lang.t('company.cta_assessment') }}</p>
                <p class="text-xs text-slate-500">{{ lang.t('company.cta_assessment_desc') }}</p>
              </div>
            </a>
            <a routerLink="/supply-chain" class="flex items-center gap-4 p-4 bg-slate-800/30 rounded-lg hover:bg-white transition-colors group">
            ...
            <a routerLink="/board-risk" class="flex items-center gap-4 p-4 bg-slate-800/30 rounded-lg hover:bg-white transition-colors group">
