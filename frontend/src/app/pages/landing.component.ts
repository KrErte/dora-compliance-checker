  ...
  template: `
    ...
    <div class="py-8 px-4 bg-gradient-to-b from-slate-800/60 to-slate-900/60 border-y border-slate-700/30">
      <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div *ngIf="publicStats" class="grid grid-cols-3 gap-6 md:gap-8">
          <!-- Registered users -->
          <div class="text-center">
            <div class="flex items-center justify-center gap-2 mb-1">
              ...
              <span class="text-3xl font-extrabold text-emerald-400">{{ publicStats.userCount }}+</span>
            </div>
            <div class="text-xs text-slate-400 uppercase tracking-wider">{{ lang.t('landing.social_users') }}</div>
          </div>
          <!-- Contracts analyzed -->
          <div class="text-center">
            <div class="flex items-center justify-center gap-2 mb-1">
