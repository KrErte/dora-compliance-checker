      ...
      <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <a routerLink="/dashboard"
           class="bg-blue-500 hover:bg-blue-600
                  ...
                  hover:shadow-lg hover:shadow-blue-500/30 flex items-center gap-1.5 whitespace-nowrap">
          Go to Dashboard
    ...
    <div class="relative overflow-hidden">
      ...
      <div class="relative flex flex-col items-center justify-center min-h-[60vh] text-center z-10 py-16 px-4">
        ...
        <div class="flex flex-col items-center gap-4">
          @if (auth.isLoggedIn()) {
            <a routerLink="/dashboard"
               class="group inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-600
      ...
      <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-8">
          ...
          <a href="https://cal.com/kristo.erte/15min" target="_blank" rel="noopener"
             class="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-white font-bold text-base shadow-lg hover:shadow-blue-500/30 transition-all duration-300 mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
