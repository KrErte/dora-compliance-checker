      ...
      <div class="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <a routerLink="/dashboard"
           class="bg-blue-600 hover:bg-blue-700
                  ...
                  hover:shadow-lg hover:shadow-lg flex items-center gap-1.5 whitespace-nowrap">
          Go to Dashboard
      ...
      <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-8">
          ...
          <a href="https://cal.com/kristo.erte/15min" target="_blank" rel="noopener"
             class="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-slate-900 font-bold text-base shadow-lg shadow-lg hover:shadow-blue-600/40 transition-all duration-300 mb-3">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
