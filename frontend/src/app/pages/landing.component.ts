      ...
      <div class="relative flex flex-col items-center justify-center min-h-[60vh] text-center z-10 py-16 px-4">
        ...
        <div class="flex flex-col items-center gap-4">
          @if (auth.isLoggedIn()) {
            ...
            <p class="text-xs mt-1.5 flex items-center justify-center gap-1">
              <svg class="w-3.5 h-3.5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
              </svg>
              <span class="font-semibold text-slate-500">{{ lang.l('Andmed on krüpteeritud ja kustutatakse pärast analüüsi', 'Your data is encrypted and deleted after analysis') }}</span>
            </p>
          }
        </div>
      </div>
