      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
          ...
          <div *ngIf="success" class="text-center space-y-4">
            ...
            <p class="text-sm text-emerald-300">{{ lang.t('auth.reset_password_success') }}</p>
            <a routerLink="/login"
               class="inline-flex items-center gap-2 text-sm text-emerald-400 hover:text-emerald-300 font-medium transition-colors">
          ...
          <form *ngIf="!success && !invalidToken" (ngSubmit)="onSubmit()">
            ...
            <div class="mb-4">
              <label for="new-password" class="block text-sm font-medium text-slate-300 mb-2">{{ lang.t('auth.new_password') }}</label>
            ...
            <div class="mb-6">
              <label for="confirm-password" class="block text-sm font-medium text-slate-300 mb-2">{{ lang.t('auth.confirm_password') }}</label>
