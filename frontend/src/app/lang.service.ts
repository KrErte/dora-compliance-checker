...
const TRANSLATIONS: { [key: string]: { et: string; en: string } } = {
  ...
  // Onboarding Modal
  'onboarding.title': { et: 'Alusta oma esimest DORA kontrolli', en: 'Start your first DORA check' },
  'onboarding.subtitle': { et: 'Laadi \u00fcles IKT leping ja saa vastavushinnang 5 minutiga', en: 'Upload an ICT contract and get your compliance score in 5 minutes' },
  'onboarding.cta_upload': { et: 'Laadi leping \u00fcles', en: 'Upload contract' },
  'onboarding.cta_skip': { et: 'Vahele, uurin ise', en: 'Skip, I\'ll explore first' },
};
