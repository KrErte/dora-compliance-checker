 ...
 *
 * <p>Usage: register the extension on your test class and use the static methods to stub responses.
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Note: the Claude API URL is currently hardcoded in services. To fully intercept calls,
 * services must be refactored to read {@code anthropic.api.base-url} from config. This extension
 * sets the system property {@code wiremock.port} so that {@code application-test.properties} can
 * reference it.
 */
public class ClaudeApiMockExtension
