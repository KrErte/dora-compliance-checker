...
class AuthControllerTest {
    ...
    void setUp() {
        authController = new AuthController(
                userRepository, passwordEncoder, jwtService, emailService,
                userDeletionService, "https://doraaudit.eu", 7
        );
    }
    ...
    class ResetPassword {
        ...
        void validToken_resetsPassword() {
            ...
            var response = authController.resetPassword(Map.of(
                    "token", "valid-token",
    ...
    class Login {
        ...
        void validCredentials_returnsToken() {
            ...
            var response = authController.login(
                    new com.dorachecker.security.AuthDtos.LoginRequest("test@example.com", "password123")
            );
