...
class IctProviderControllerTest {
    ...
    private IctProviderController.CreateProviderRequest makeRequest(
            String name, String country, String countryCode, String type,
            String criticality, String contractNumber, String contractStart,
            String contractEnd, Integer riskScore, Boolean hasExitStrategy,
            String exitStrategyDescription, String subcontractors) {
        return new IctProviderController.CreateProviderRequest(
                name, country, countryCode, type, criticality, contractNumber,
                contractStart, contractEnd, riskScore, hasExitStrategy,
                exitStrategyDescription, subcontractors);
    }
    ...
    private IctProviderController.CreateProviderRequest makeSimpleRequest(
        ...
        return makeRequest("Test Provider", "Test Country", countryCode,
                "Cloud", criticality, "C-001", null, null,
                null, hasExitStrategy, null, null);
    }

    private void stubGlobalRegistryEmpty() {
        when(globalProviderRepository.findByNameIgnoreCase(anyString()))
    ...
    class CreateProvider {
        ...
        @Test
        void nullAuth_returns401() {
            var request = makeRequest("Test", "Estonia", "EE", "Cloud",
                    "normal", "C-001", null, null, null, true, null, null);
        ...
        void validRequest_createsProvider() {
            ...
            var request = makeRequest("Acme Cloud", "Estonia", "EE", "Cloud",
                    "critical", "C-100", "2025-01-01", "2026-12-31",
                    null, true, "Migration plan exists", "Sub1, Sub2");
        ...
        void invalidDateFormat_returns400() {
            ...
            var request = makeRequest("Test", "Estonia", "EE", "Cloud",
                    "normal", "C-001", "not-a-date", null, null, true, null, null);
        ...
        void nullType_defaultsToMuu() {
            ...
            var request = makeRequest("Test", "Estonia", "EE", null,
                    "normal", "C-001", null, null, null, true, null, null);
    ...
    class CreateProvidersBatch {
        ...
        void nullAuth_returns401() {
            var requests = List.of(
                    makeRequest("P1", "Estonia", "EE", "Cloud",
                            "normal", "C-001", null, null, null, true, null, null));
        ...
        void validBatch_createsAll() {
            ...
            var requests = List.of(
                    makeRequest("P1", "Estonia", "EE", "Cloud",
                            "normal", "C-001", "2025-01-01", null, null, true, null, null),
                    makeRequest("P2", "Germany", "DE", "SaaS",
                            "critical", "C-002", null, "2026-06-30", null, false, null, null),
                    makeRequest("P3", "USA", "US", "IaaS",
                            "important", "C-003", null, null, null, true, null, null));
        ...
        void invalidDateInBatch_returns400() {
            ...
            var requests = List.of(
                    makeRequest("P1", "Estonia", "EE", "Cloud",
                            "normal", "C-001", "2025-01-01", null, null, true, null, null),
                    makeRequest("P2", "Germany", "DE", "SaaS",
                            "normal", "C-002", "bad-date", null, null, true, null, null));
    ...
    class RiskScoreCalculation {
        ...
        /**
         * Risk score is calculated by the private calculateRiskScore method.
         * We verify the calculated score via the saved entity when riskScore is null in the request.
         *
         * Formula: Math.min(100, baseScore + criticalityMod + exitMod)
         *
         * Base scores:
         *   EE = 15, EU = 20, TRUSTED_NON_EU = 30, OTHER_NON_EU = 35,
         *   HIGH_RISK = 55, null/unknown = 40
         *
         * Criticality modifiers:
         *   critical = 25, important = 10, normal/default = 5
         *
         * Exit strategy modifier:
         *   hasExitStrategy=true -> 0, hasExitStrategy=false/null -> 15
         */
