...
class IctAssetMapServiceTest {
  ...
  @Mock private IctProviderRepository providerRepo;

  @InjectMocks private IctAssetMapService service;
  ...
  class AddLink {
    ...
    void addingLink_returnsSuccess() {
      Map<String, Object> funcResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "Test Func"));
      @SuppressWarnings("unchecked")
    ...
    void linkHasCorrectSourceAndTargetIds() {
      Map<String, Object> funcResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "Source Func"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");
      Map<String, Object> assetResult =
          service.addIctAsset(USER_ID, Map.of("name", "Target Asset"));
      @SuppressWarnings("unchecked")
      String assetId = (String) ((Map<String, Object>) assetResult.get("asset")).get("id");
    ...
    void defaultDependency_isRequired() {
      Map<String, Object> funcResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "Func A"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");
  ...
  class DeleteBusinessFunction {
    ...
    void deletingFunction_removesItFromList() {
      ...
      Map<String, Object> addResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "To Be Deleted"));
      @SuppressWarnings("unchecked")
    ...
    void deletingFunction_alsoRemovesAssociatedLinks() {
      ...
      Map<String, Object> funcResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "My Function"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

      Map<String, Object> assetResult = service.addIctAsset(USER_ID, Map.of("name", "My Asset"));
      @SuppressWarnings("unchecked")
      String assetId = (String) ((Map<String, Object>) assetResult.get("asset")).get("id");
  ...
  class DeleteIctAsset {
    ...
    void deletingAsset_removesIt() {
      ...
      Map<String, Object> addResult = service.addIctAsset(USER_ID, Map.of("name", "Doomed Asset"));
      @SuppressWarnings("unchecked")
    ...
    void deletingAsset_removesAssociatedLinks() {
      ...
      // Add function and asset
      Map<String, Object> funcResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "Core Function"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

      Map<String, Object> assetResult = service.addIctAsset(USER_ID, Map.of("name", "Core Asset"));
      @SuppressWarnings("unchecked")
      String assetId = (String) ((Map<String, Object>) assetResult.get("asset")).get("id");
  ...
  class DeleteLink {
    ...
    void deletingLink_removesOnlyThatLink() {
      ...
      Map<String, Object> funcCResult =
          service.addBusinessFunction(USER_ID, Map.of("name", "Func C"));
      @SuppressWarnings("unchecked")
      ...
      // Add two links
      Map<String, Object> link1Result =
          service.addLink(USER_ID, Map.of("sourceId", funcAId, "targetId", assetBId));
      @SuppressWarnings("unchecked")
  ...
  class GetDependencyMap {
    ...
    void includesIctProvidersFromDatabase() {
      ...
      when(providerRepo.findByUserIdOrderByCreatedAtDesc(USER_ID)).thenReturn(List.of(provider));
  ...
  class AnalyzeRisks {
    ...
    void unmappedCriticalFunction_detectedAsHighSeverity() {
      service.addBusinessFunction(
          USER_ID, Map.of("name", "Critical Payments", "criticality", "CRITICAL"));

      Map<String, Object> risks = service.analyzeRisks(USER_ID);

      @SuppressWarnings("unchecked")
      List<Map<String, Object>> unmapped =
          (List<Map<String, Object>>) risks.get("unmappedFunctions");
    ...
    void unmappedNormalFunction_detectedAsMediumSeverity() {
      service.addBusinessFunction(
          USER_ID, Map.of("name", "Internal Reporting", "criticality", "NORMAL"));
    ...
    void singlePointOfFailure_detectedForCriticalFunctionWithOneLink() {
      ...
      Map<String, Object> funcResult =
          service.addBusinessFunction(
              USER_ID, Map.of("name", "Core Trading", "criticality", "CRITICAL"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

      // Add an asset
      Map<String, Object> assetResult =
          service.addIctAsset(USER_ID, Map.of("name", "Trading Platform"));
      @SuppressWarnings("unchecked")
      String assetId = (String) ((Map<String, Object>) assetResult.get("asset")).get("id");
      ...
      @SuppressWarnings("unchecked")
      List<Map<String, Object>> spof =
          (List<Map<String, Object>>) risks.get("singlePointsOfFailure");
    ...
    void riskLevelCritical_whenThreeOrMoreHighCriticalIssues() {
      ...
      for (int i = 1; i <= 3; i++) {
        Map<String, Object> funcResult =
            service.addBusinessFunction(
                USER_ID, Map.of("name", "Critical Func " + i, "criticality", "CRITICAL"));
        @SuppressWarnings("unchecked")
        String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

        Map<String, Object> assetResult =
            service.addIctAsset(USER_ID, Map.of("name", "Asset " + i));
        @SuppressWarnings("unchecked")
        String assetId = (String) ((Map<String, Object>) assetResult.get("asset")).get("id");
    ...
    void riskLevelLow_whenNoIssues() {
      ...
      Map<String, Object> funcResult =
          service.addBusinessFunction(
              USER_ID, Map.of("name", "Standard Function", "criticality", "NORMAL"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

      Map<String, Object> asset1Result = service.addIctAsset(USER_ID, Map.of("name", "Asset A"));
      @SuppressWarnings("unchecked")
      String asset1Id = (String) ((Map<String, Object>) asset1Result.get("asset")).get("id");

      Map<String, Object> asset2Result = service.addIctAsset(USER_ID, Map.of("name", "Asset B"));
      @SuppressWarnings("unchecked")
    ...
    void noFalsePositives_whenEverythingIsProperlyMapped() {
      ...
      Map<String, Object> funcResult =
          service.addBusinessFunction(
              USER_ID, Map.of("name", "Well-Mapped Function", "criticality", "CRITICAL"));
      @SuppressWarnings("unchecked")
      String funcId = (String) ((Map<String, Object>) funcResult.get("function")).get("id");

      Map<String, Object> asset1Result =
          service.addIctAsset(USER_ID, Map.of("name", "Primary System"));
      @SuppressWarnings("unchecked")
      String asset1Id = (String) ((Map<String, Object>) asset1Result.get("asset")).get("id");

      Map<String, Object> asset2Result =
          service.addIctAsset(USER_ID, Map.of("name", "Backup System"));
      @SuppressWarnings("unchecked")
      String asset2Id = (String) ((Map<String, Object>) asset2Result.get("asset")).get("id");
