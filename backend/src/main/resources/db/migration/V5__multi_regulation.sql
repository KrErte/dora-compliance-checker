...
VALUES (
    ...
    'EL-i määrus finantssektori digitaalse tegevuskerksuse kohta, keskendudes IKT riskihaldusele, intsidentidest teavitamisele, vastupidavuse testimisele ja kolmandate osapoolte riskihaldusele.',
    '2025-01-17',
    TRUE
);
