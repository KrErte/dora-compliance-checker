 ...
 *
 * <p>Only runs when app.seed.enabled=true (default: false). Production has this hardcoded to false
...
public class DevDataSeeder implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    seedEnterpriseUser("Test Admin", "admin@doraaudit.eu", "Admin1234", Role.ADMIN);
    seedEnterpriseUser("Test User", "user@doraaudit.eu", "User1234", Role.USER);
    seedEnterpriseUser("Demo User", "demo@doraaudit.eu", "Demo1234", Role.USER);
  ...
  private void seedEnterpriseUser(String fullName, String email, String rawPassword, Role role) {
    ...
    if (existing.isPresent()) {
      // Always reset password so seed credentials stay valid
      ...
      userRepository.save(user);
      log.info("DevDataSeeder: Updated existing enterprise user {} password and tier", email);
      return;
    }
