            ...
            a ->
                results.add(
                    Map.of(
                        ...
                        "url", "/results/" + a.getId(),
                        "date",
                            a.getAssessmentDate() != null
                                ? a.getAssessmentDate().toString()
                                : "")));
            ...
            c ->
                results.add(
                    Map.of(
                        ...
                        "date",
                            c.getAnalysisDate() != null ? c.getAnalysisDate().toString() : "")));
            ...
            i ->
                results.add(
                    Map.of(
                        ...
                        i.getIncidentTitle(),
                        "snippet",
                        i.getSeverityLevel() + " – " + i.getReportingStatus(),
                        "url",
                        "/incident-reporting",
                        "date",
            ...
            r ->
                results.add(
                    Map.of(
                        ...
                        "snippet",
                        "RoI Register – "
                            + (r.getStatus() != null ? r.getStatus().name() : "DRAFT"),
                        "url",
                        "/roi",
                        "date",
