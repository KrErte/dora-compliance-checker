...
public class WorkspaceService {
  ...
  private static final List<RegulationCheck> DORA_ART30_CHECKS =
      List.of(
          new RegulationCheck(
              "dora_30_1",
              "Service description",
          ...
          new RegulationCheck(
              "dora_30_3",
              "Service levels",
              "Quantitative and qualitative service level descriptions",
              "DORA Art. 30(2)(c)"),
          new RegulationCheck(
              "dora_30_4",
              "Availability targets",
              "Availability, authenticity, integrity targets",
              "DORA Art. 30(2)(d)"),
          new RegulationCheck(
              "dora_30_5",
              "Data protection",
              "Provisions ensuring data protection",
              "DORA Art. 30(2)(e)"),
          new RegulationCheck(
              "dora_30_6",
              "Data access",
              "Guaranteed access to data in case of insolvency/termination",
              "DORA Art. 30(2)(f)"),
          new RegulationCheck(
              "dora_30_7",
              "Data return",
              "Timely and orderly data return and deletion",
              "DORA Art. 30(2)(g)"),
          new RegulationCheck(
              "dora_30_8",
              "Audit rights",
              "Full access and audit rights for entity and authorities",
              "DORA Art. 30(2)(h)"),
          new RegulationCheck(
              "dora_30_9",
              "Cooperation",
          ...
          new RegulationCheck(
              "dora_30_10",
              "Termination rights",
              "Clear termination rights and minimum notice periods",
              "DORA Art. 30(2)(j)"),
          new RegulationCheck(
              "dora_30_11",
              "Exit strategy",
  ...
  private static final List<RegulationCheck> GDPR_ART28_CHECKS =
      List.of(
          new RegulationCheck(
              "gdpr_28_1",
          ...
          new RegulationCheck(
              "gdpr_28_2",
              "Confidentiality",
              "Ensure persons processing data are under confidentiality",
              "GDPR Art. 28(3)(b)"),
          new RegulationCheck(
              "gdpr_28_3",
              "Security measures",
          ...
          new RegulationCheck(
              "gdpr_28_8",
              "Audit compliance",
              "Make available information for compliance demonstration",
              "GDPR Art. 28(3)(h)"),
          new RegulationCheck(
              "gdpr_28_9",
              "Processing scope",
  ...
  private static final List<RegulationCheck> SLA_CHECKS =
      List.of(
          new RegulationCheck(
              "sla_1",
              "Uptime SLA",
              "Defined uptime percentage (e.g., 99.9%)",
              "SLA Best Practice"),
          new RegulationCheck(
              "sla_2", "Response time", "Maximum response time for requests", "SLA Best Practice"),
          new RegulationCheck(
              "sla_3", "Support hours", "Support availability hours", "SLA Best Practice"),
          new RegulationCheck(
              "sla_4",
              "Incident response",
          ...
          new RegulationCheck(
              "sla_7", "SLA credits", "Service credits for SLA breaches", "SLA Best Practice"),
          new RegulationCheck(
              "sla_8", "Maintenance windows", "Scheduled maintenance windows", "SLA Best Practice"),
          new RegulationCheck(
              "sla_9", "Escalation path", "Clear escalation procedures", "SLA Best Practice"),
          new RegulationCheck(
              "sla_10", "Reporting", "Regular service level reporting", "SLA Best Practice"));

  private static final List<RegulationCheck> NIS2_CHECKS =
      List.of(
          new RegulationCheck(
              "nis2_1",
              "Supply chain security",
              "Security measures in supply chain",
              "NIS2 Art. 21(2)(d)"),
          new RegulationCheck(
              "nis2_2", "Vendor assessment", "Security assessment of suppliers", "NIS2 Art. 21(3)"),
          new RegulationCheck(
              "nis2_3",
          ...
          new RegulationCheck(
              "nis2_4",
              "Risk management",
              "Risk management measures in contracts",
              "NIS2 Art. 21(1)"),
          new RegulationCheck(
              "nis2_5",
              "Business continuity",
