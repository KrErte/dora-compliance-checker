...
public class ContractAnalysisService {
  ...
  public ContractAnalysisResult analyze(
      String companyName, String contractName, MultipartFile file) {
    ...
    ContractAnalysisEntity entity =
        new ContractAnalysisEntity(
            companyName,
            contractName,
  ...
  public ContractAnalysisResult analyzeFromText(
      String contractText,
      String companyName,
      String contractName,
      String fileName,
    ...
    if (contractText == null || contractText.isBlank()) {
      throw new IllegalArgumentException(
          "Lepingutekst on tühi. Uuesti analüüsimine pole võimalik.");
    }
              ...
              try {
                findings =
                    objectMapper.readValue(
                        entity.getFindingsJson(), new TypeReference<List<ContractFinding>>() {});
              } catch (Exception e) {
                findings = List.of();
              }
              return new ContractAnalysisResult(
