...
public class PdfExportService {
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph("DORA Compliance Assessment Report")
              .setFontSize(22)
              .setBold()
      ...
      if (assessment.getAnswersJson() != null && !assessment.getAnswersJson().isBlank()) {
        doc.add(
            new Paragraph("Question Details")
                .setFontSize(16)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(12));
        ...
        try {
          ...
          Table table =
              new Table(UnitValue.createPercentArray(new float[] {1, 4, 2, 4}))
                  .useAllAvailableWidth()
                  .setFontSize(9)
                  .setMarginTop(8);
          addHeaderCell(table, "#");
      ...
      doc.add(new Paragraph(" ").setFontSize(8));
      doc.add(
          new Paragraph("Generated by DoraAudit.eu — DORA Compliance Platform")
              .setFontSize(8)
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph("DORA Art. 30 Contract Analysis Report")
              .setFontSize(22)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY));
      doc.add(new Paragraph(" ").setFontSize(8));
      ...
      if (contract.getFindingsJson() != null && !contract.getFindingsJson().isBlank()) {
        ...
        try {
          ...
          Table table =
              new Table(UnitValue.createPercentArray(new float[] {0.5f, 3, 1, 4}))
                  .useAllAvailableWidth()
                  .setFontSize(9)
                  .setMarginTop(8);
          addHeaderCell(table, "#");
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph("ICT Incident Report — DORA Art. 19")
              .setFontSize(22)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY));
      doc.add(
          new Paragraph(incident.isMajor() ? "MAJOR INCIDENT" : "Incident Report")
              .setFontSize(12)
              .setFontColor(incident.isMajor() ? new DeviceRgb(220, 38, 38) : ColorConstants.GRAY)
              .setMarginBottom(8));
      ...
      addInfoRow(
          summary,
          "Detected At",
          incident.getDetectedAt() != null ? incident.getDetectedAt().format(DATE_FMT) : "N/A");
      addInfoRow(
          summary,
          "Classified At",
          incident.getClassifiedAt() != null ? incident.getClassifiedAt().format(DATE_FMT) : "N/A");
      addInfoRow(
          summary,
          "Resolved At",
          incident.getResolvedAt() != null ? incident.getResolvedAt().format(DATE_FMT) : "N/A");
      doc.add(summary);

      // Art. 18 Classification criteria
      doc.add(
          new Paragraph("DORA Art. 18 — Classification Criteria")
              .setFontSize(16)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY)
              .setMarginTop(12));
      ...
      Table criteria =
          new Table(UnitValue.createPercentArray(new float[] {2, 3}))
              .useAllAvailableWidth()
              .setFontSize(10)
              .setMarginTop(8);
      addInfoRow(
          criteria,
          "Clients Affected",
          incident.getClientsAffected() != null
              ? String.valueOf(incident.getClientsAffected())
              : "N/A");
      addInfoRow(
          criteria,
          "Transactions Affected",
          incident.getTransactionsAffected() != null
              ? String.valueOf(incident.getTransactionsAffected())
              : "N/A");
      addInfoRow(
          criteria,
          "Geographical Spread",
      ...
      addInfoRow(
          ...
          incident.getCriticalServicesAffected() != null
              ? incident.getCriticalServicesAffected()
              : "N/A");
      addInfoRow(
          criteria,
          "Economic Impact",
          incident.getEconomicImpact() != null
              ? String.format("€%.2f", incident.getEconomicImpact())
              : "N/A");
      addInfoRow(
          criteria,
          "Duration (minutes)",
          incident.getDurationMinutes() != null
              ? String.valueOf(incident.getDurationMinutes())
              : "N/A");
      addInfoRow(
          criteria,
          "Reputational Impact",
      ...
      // Reporting timeline
      doc.add(
          new Paragraph("Reporting Timeline")
              .setFontSize(16)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY)
              .setMarginTop(16));
      ...
      Table timeline =
          new Table(UnitValue.createPercentArray(new float[] {2, 2, 2}))
              .useAllAvailableWidth()
              .setFontSize(9)
              .setMarginTop(8);
      ...
      timeline.addCell(
          new Cell().add(new Paragraph("Initial Notification (4h)").setFontSize(9)).setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getInitialReportDueAt() != null
                              ? incident.getInitialReportDueAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getInitialReportSentAt() != null
                              ? incident.getInitialReportSentAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));

      timeline.addCell(
          new Cell().add(new Paragraph("Intermediate Report (72h)").setFontSize(9)).setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getIntermediateReportDueAt() != null
                              ? incident.getIntermediateReportDueAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getIntermediateReportSentAt() != null
                              ? incident.getIntermediateReportSentAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));

      timeline.addCell(
          new Cell().add(new Paragraph("Final Report (1 month)").setFontSize(9)).setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getFinalReportDueAt() != null
                              ? incident.getFinalReportDueAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));
      timeline.addCell(
          new Cell()
              .add(
                  new Paragraph(
                          incident.getFinalReportSentAt() != null
                              ? incident.getFinalReportSentAt().format(DATE_FMT)
                              : "—")
                      .setFontSize(9))
              .setPadding(4));
      ...
      if (incident.getDescription() != null && !incident.getDescription().isBlank()) {
        doc.add(
            new Paragraph("Incident Description")
                .setFontSize(14)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(16));
      ...
      if (incident.getRootCause() != null && !incident.getRootCause().isBlank()) {
        doc.add(
            new Paragraph("Root Cause Analysis")
                .setFontSize(14)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(12));
      ...
      if (incident.getRemediationActions() != null && !incident.getRemediationActions().isBlank()) {
        doc.add(
            new Paragraph("Remediation Actions")
                .setFontSize(14)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(12));
      ...
      if (incident.getCompetentAuthority() != null || incident.getReportingContactName() != null) {
        doc.add(
            new Paragraph("Competent Authority & Contact")
                .setFontSize(14)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(16));
  ...
  private void addInfoRow(Table table, String label, String value) {
    table.addCell(
        new Cell()
            ...
            .setPadding(6));
    table.addCell(
        new Cell().add(new Paragraph(value != null ? value : "N/A").setFontSize(10)).setPadding(6));
  }
  ...
  private Cell statusCell(String status) {
    ...
    switch (status.toLowerCase()) {
      case "compliant", "found", "yes" -> {
        bg = new DeviceRgb(220, 252, 231);
        fg = new DeviceRgb(22, 101, 52);
        label = status;
      }
      case "partial" -> {
        bg = new DeviceRgb(254, 249, 195);
        fg = new DeviceRgb(133, 77, 14);
        label = status;
      }
      case "non_compliant", "missing", "no" -> {
        bg = new DeviceRgb(254, 226, 226);
        fg = new DeviceRgb(153, 27, 27);
        label = status;
      }
      default -> {
        bg = new DeviceRgb(241, 245, 249);
    ...
    return new Cell()
        .add(new Paragraph(label).setFontSize(9).setFontColor(fg))
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph("DORA Evidence Gap Analysis Report")
              .setFontSize(22)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY));
      doc.add(new Paragraph(" ").setFontSize(8));
      ...
      addInfoRow(
          summary,
          "Date",
          gap.getAnalysisDate() != null ? gap.getAnalysisDate().format(DATE_FMT) : "N/A");
      ...
      if (gap.getFindingsJson() != null && !gap.getFindingsJson().isBlank()) {
        doc.add(
            new Paragraph("Detailed Findings")
                .setFontSize(16)
                .setBold()
                .setFontColor(ColorConstants.DARK_GRAY)
                .setMarginTop(12));
        ...
        try {
          List<Map<String, Object>> findings =
              objectMapper.readValue(gap.getFindingsJson(), new TypeReference<>() {});

          // Group by article
          java.util.LinkedHashMap<String, List<Map<String, Object>>> grouped =
          ...
          for (Map.Entry<String, List<Map<String, Object>>> group : grouped.entrySet()) {
            ...
            Table table =
                new Table(UnitValue.createPercentArray(new float[] {0.5f, 2.5f, 1, 2, 3}))
                    .useAllAvailableWidth()
                    .setFontSize(8)
                    .setMarginTop(4);
            addHeaderCell(table, "#");
            ...
            for (Map<String, Object> f : group.getValue()) {
              ...
              String requirement =
                  getString(f, "subRequirementEn", getString(f, "subRequirementEt", ""));
              String status = getString(f, "status", "");
              String quote = getString(f, "quoteFromDocument", "");
              String recommendation =
                  getString(f, "recommendationEn", getString(f, "recommendationEt", ""));

              table.addCell(new Cell().add(new Paragraph(reqId).setFontSize(8)).setPadding(3));
              table.addCell(
                  new Cell().add(new Paragraph(requirement).setFontSize(8)).setPadding(3));
              table.addCell(statusCell(status));
              table.addCell(new Cell().add(new Paragraph(quote).setFontSize(8)).setPadding(3));
              table.addCell(
                  new Cell().add(new Paragraph(recommendation).setFontSize(8)).setPadding(3));
            }
            doc.add(table);
          }
        } catch (Exception e) {
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph("DORA Compliance Board Package")
              .setFontSize(22)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY));
      doc.add(
          new Paragraph("Executive Summary Report")
              .setFontSize(14)
              .setFontColor(ColorConstants.GRAY)
              .setMarginBottom(16));
      ...
      doc.add(
          new Paragraph("Overall Health Score: " + healthScore + "%")
              .setFontSize(18)
              .setBold()
              .setFontColor(BRAND_COLOR)
              .setMarginBottom(12));
      ...
      if (assessment != null && !assessment.isEmpty()) {
        ...
        Table t =
            new Table(UnitValue.createPercentArray(new float[] {1, 2}))
                ...
                .setMarginTop(4);
        addInfoRow(
            t, "Latest Score", String.valueOf(assessment.getOrDefault("latestScore", "N/A")));
        addInfoRow(
            t,
            "Compliance Level",
            String.valueOf(assessment.getOrDefault("complianceLevel", "N/A")));
      ...
      doc.add(
          new Paragraph(
                  "Generated by DoraAudit.eu — DORA Compliance Platform | "
                      + data.getOrDefault("generatedAt", ""))
              .setFontSize(8)
              .setFontColor(ColorConstants.GRAY)
              .setTextAlignment(TextAlignment.CENTER));
    ...
    try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
      ...
      doc.add(
          new Paragraph("DoraAudit.eu")
              ...
              .setMarginBottom(4));
      doc.add(
          new Paragraph(title != null ? title : "AI Act Document")
              .setFontSize(20)
              .setBold()
              .setFontColor(ColorConstants.DARK_GRAY));
      doc.add(new Paragraph(" ").setFontSize(8));
      ...
      if (markdownContent != null) {
        for (String line : markdownContent.split("\n")) {
          if (line.startsWith("# ")) {
            doc.add(
                new Paragraph(line.substring(2))
                    .setFontSize(18)
                    .setBold()
                    .setFontColor(ColorConstants.DARK_GRAY)
                    .setMarginTop(12));
            ...
            doc.add(
                new Paragraph(line.substring(3))
                    .setFontSize(15)
                    .setBold()
                    .setFontColor(ColorConstants.DARK_GRAY)
                    .setMarginTop(10));
            ...
            doc.add(
                new Paragraph(line.substring(4))
                    .setFontSize(13)
                    .setBold()
                    .setFontColor(ColorConstants.DARK_GRAY)
                    .setMarginTop(8));
      ...
      doc.add(
          new Paragraph("Generated by DoraAudit.eu — EU AI Act Compliance")
              .setFontSize(8)
              .setFontColor(ColorConstants.GRAY)
              .setTextAlignment(TextAlignment.CENTER));
