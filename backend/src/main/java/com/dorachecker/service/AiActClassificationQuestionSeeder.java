...
public class AiActClassificationQuestionSeeder {
    ...
    private static final Logger log = LoggerFactory.getLogger(AiActClassificationQuestionSeeder.class);
    ...
    public ApplicationRunner seedAiActClassificationQuestions(ClassificationQuestionRepository repo) {
        return args -> {
            ...
            repo.save(question("PROHIBITED_SOCIAL_SCORING",
            ...
            repo.save(question("PROHIBITED_SUBLIMINAL",
            ...
            repo.save(question("PROHIBITED_VULNERABILITY",
            ...
            repo.save(question("PROHIBITED_FACIAL_SCRAPING",
            ...
            repo.save(question("PROHIBITED_EMOTION_WORKPLACE",
            ...
            repo.save(question("PROHIBITED_BIOMETRIC_CATEGORIZATION",
            ...
            repo.save(question("PROHIBITED_PREDICTIVE_POLICING",
            ...
            // === HIGH RISK — Annex III ===
            repo.save(question("HIGH_BIOMETRICS",
            ...
            repo.save(question("HIGH_CRITICAL_INFRASTRUCTURE",
            ...
            repo.save(question("HIGH_EDUCATION",
            ...
            repo.save(question("HIGH_EMPLOYMENT",
            ...
            repo.save(question("HIGH_ESSENTIAL_SERVICES",
            ...
            repo.save(question("HIGH_LAW_ENFORCEMENT",
            ...
            repo.save(question("HIGH_MIGRATION",
            ...
            repo.save(question("HIGH_JUSTICE",
            ...
            repo.save(question("HIGH_SAFETY_COMPONENT",
            ...
            repo.save(question("HIGH_SAFETY_THIRD_PARTY",
            ...
            // === LIMITED RISK (Art 50) ===
            repo.save(question("LIMITED_CHATBOT",
            ...
            repo.save(question("LIMITED_SYNTHETIC_CONTENT",
            ...
            repo.save(question("LIMITED_EMOTION_RECOGNITION",
            ...
            // === EXEMPTIONS (Art 6(3)) ===
            repo.save(question("EXEMPTION_NARROW_PROCEDURAL",
                ...
                "EXEMPTION", order++, null, null));

            repo.save(question("EXEMPTION_IMPROVE_HUMAN_ACTIVITY",
            ...
            repo.save(question("EXEMPTION_PREPARATORY_TASK",
            ...
            repo.save(question("EXEMPTION_DETECT_PATTERNS",
    ...
    private ClassificationQuestionEntity question(String key, String textEn, String textEt,
                                                    String category, int order,
                                                    String helpEn, String helpEt) {
