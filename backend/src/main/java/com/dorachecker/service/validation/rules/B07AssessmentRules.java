...
public class B07AssessmentRules implements RoiValidationRule {
    ...
    @Override public String getRuleId() { return "B07"; }
    @Override public String getSeverity() { return "WARNING"; }
    @Override public String getTemplateCode() { return "B_07"; }
    ...
    public List<RoiViolation> evaluate(RoiValidationContext ctx) {
        ...
        for (RoiAssessmentEntity a : ctx.getRegister().getAssessments()) {
            ...
            if (!ctx.getContractRefs().contains(ref)) {
                violations.add(new RoiViolation("VR_71", "ERROR", "FK_INTEGRITY", "B_07.01", "C0010", ref,
                    "Lepingu viide '" + ref + "' ei leidu B_02.01 tabelis",
                    "Contract ref '" + ref + "' not found in B_02.01"));
            }

            // Risk level from closed list
            if (a.getRiskLevel() != null && !a.getRiskLevel().isBlank() && !RISK_LEVELS.contains(a.getRiskLevel())) {
                violations.add(new RoiViolation("VR_ASS_RISK", "WARNING", "FORMAT", "B_07.01", "C0030", ref,
            ...
            if (a.getAssessmentDate() == null) {
                violations.add(new RoiViolation("DQ_09", "WARNING", "DATA_QUALITY", "B_07.01", "C0020", ref,
                ...
                if (a.getAssessmentDate().isBefore(LocalDate.now().minusMonths(12))) {
                    violations.add(new RoiViolation("VR_ASS_OLD", "WARNING", "BUSINESS", "B_07.01", "C0020", ref,
            ...
            if (a.getLastAuditDate() == null) {
                violations.add(new RoiViolation("DQ_10", "WARNING", "DATA_QUALITY", "B_07.01", "C0060", ref,
            ...
            if (("Critical".equals(a.getRiskLevel()) || "High".equals(a.getRiskLevel()))
                ...
                violations.add(new RoiViolation("VR_ASS_EXIT", "WARNING", "BUSINESS", "B_07.01", "C0040", ref,
            ...
            if (("Critical".equals(a.getRiskLevel()) || "High".equals(a.getRiskLevel()))
                ...
                violations.add(new RoiViolation("DQ_04", "WARNING", "DATA_QUALITY", "B_07.01", "C0050", ref,
                    "Kriitilise/kõrge riskitasemega lepingu '" + ref + "' hindamisel puudub asendatavuse hinnang",
                    "Contract '" + ref + "' with Critical/High risk is missing substitutability assessment"));
            }
            ...
            if (("Critical".equals(a.getRiskLevel()) || "High".equals(a.getRiskLevel()))
                ...
                violations.add(new RoiViolation("DQ_05", "WARNING", "DATA_QUALITY", "B_07.01", "C0040", ref,
                    "Kriitilise riskitasemega lepingu '" + ref + "' puhul pole alternatiivseid pakkujaid tuvastatud",
                    "Contract '" + ref + "' with Critical/High risk has no alternative providers identified"));
            }
        }
