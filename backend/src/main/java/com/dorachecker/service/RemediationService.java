...
public class RemediationService {
  ...
  public RemediationItemEntity create(String userId, Map<String, Object> body) {
    ...
    RemediationItemEntity entity =
        new RemediationItemEntity(
            userId, title, description, source, sourceId, pillar, articleReference, priority);

    if (body.containsKey("assignee")) entity.setAssignee((String) body.get("assignee"));
    if (body.containsKey("dueDate"))
      entity.setDueDate(LocalDate.parse((String) body.get("dueDate")));
  ...
  public RemediationItemEntity update(String id, String userId, Map<String, Object> body) {
    ...
    if (body.containsKey("dueDate"))
      entity.setDueDate(
          body.get("dueDate") != null ? LocalDate.parse((String) body.get("dueDate")) : null);
    ...
    if (body.containsKey("articleReference"))
      entity.setArticleReference((String) body.get("articleReference"));
