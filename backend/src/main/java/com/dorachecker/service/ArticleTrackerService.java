...
public class ArticleTrackerService {
  ...
  private final ConcurrentHashMap<String, Map<String, Map<String, Object>>> userArticleData =
        ...
        buildChapter(
            ...
            List.of(
                buildArticle(
                    "art28",
                    "Article 28",
                    "General principles for ICT TPP risk",
                    "THIRD_PARTY",
                    overallScore,
                    evidenceByPillar,
                    evidenceByArticle,
                ...
                buildArticle(
                    "art29",
                    "Article 29",
                    "Preliminary assessment & concentration risk",
                    "THIRD_PARTY",
                    overallScore,
                    evidenceByPillar,
                    evidenceByArticle,
                ...
                buildArticle(
                    "art31",
                    "Article 31",
                    "Oversight framework designation",
                    "THIRD_PARTY",
                    overallScore,
                    evidenceByPillar,
                    evidenceByArticle,
                ...
                buildArticle(
                    "art32",
                    "Article 32",
                    "Structure of oversight framework",
                    "THIRD_PARTY",
                    overallScore,
                    evidenceByPillar,
                    evidenceByArticle,
  ...
  public Map<String, Object> updateArticleStatus(
      String userId, String articleId, Map<String, Object> data) {
  ...
  public Map<String, Object> getArticleDetail(String userId, String articleId) {
    ...
    Map<String, Object> userData =
        userArticleData.getOrDefault(userId, Map.of()).getOrDefault(articleId, Map.of());
  ...
  private Map<String, Object> buildChapter(
      String number, String title, String articleRange, List<Map<String, Object>> articles) {
    ...
    chapter.put(
        "progress",
        articles.isEmpty() ? 0 : Math.round(((compliant + partial * 0.5) / articles.size()) * 100));
    return chapter;
  }
  ...
  private Map<String, Object> buildArticle(
    ...
    Map<String, Object> userData =
        userArticleData.getOrDefault(userId, Map.of()).getOrDefault(id, Map.of());
    String manualStatus = (String) userData.getOrDefault("manualStatus", "");

    int evidenceCount = evidenceByArticle.containsKey(id) ? evidenceByArticle.get(id).size() : 0;
