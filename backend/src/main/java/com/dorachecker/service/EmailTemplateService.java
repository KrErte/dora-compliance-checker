...
public class EmailTemplateService {
    ...
    public String renderTeamInvitation(String inviterName, String organizationName, String acceptUrl) {
        return layout("You're Invited!",
                "<p style='color:#334155;font-size:16px;line-height:1.6'><strong>" + esc(inviterName) + "</strong> has invited you to join <strong>" + esc(organizationName) + "</strong> on DoraAudit.</p>" +
    ...
    public String renderTaskAssignment(String taskTitle, String systemName, String tasksUrl) {
        return layout("New Task Assigned",
                ...
                infoBox(
                        ...
                        "<strong>System:</strong> " + esc(systemName)
                ) +
    ...
    public String renderDeadlineAlert(String obligationTitle, String systemName, String dueDate, int daysLeft, String dashboardUrl) {
        ...
        return layout("Deadline Alert",
                ...
                infoBox(
                        ...
                        "<strong>System:</strong> " + esc(systemName) + "<br>" +
    ...
    public String renderWeeklyDigest(String userName, int totalAssessments, int complianceScore,
        ...
        String overdueSection = overdueCount > 0
                ? "<div style='background:#fef2f2;border-left:4px solid #dc2626;padding:12px 16px;border-radius:4px;margin:16px 0'>" +
                  "<strong style='color:#dc2626'>" + overdueCount + " overdue item" + (overdueCount != 1 ? "s" : "") + "</strong>" +
