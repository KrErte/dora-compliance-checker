...
public class RoiService {
  ...
  public RoiRegisterEntity updateRegister(String id, Map<String, Object> data) {
    ...
    if (data.containsKey("competentAuthority"))
      register.setCompetentAuthority((String) data.get("competentAuthority"));
  ...
  public RoiRegisterEntity addProvider(String registerId, Map<String, Object> data) {
    ...
    if (data.get("totalAnnualSpend") != null) {
      provider.setTotalAnnualSpend(
          new java.math.BigDecimal(data.get("totalAnnualSpend").toString()));
    }
  ...
  public RoiRegisterEntity addContract(String registerId, Map<String, Object> data) {
    ...
    if (data.get("startDate") != null)
      contract.setStartDate(java.time.LocalDate.parse((String) data.get("startDate")));
    if (data.get("endDate") != null)
      contract.setEndDate(java.time.LocalDate.parse((String) data.get("endDate")));
    if (data.get("noticePeriodDays") != null)
      contract.setNoticePeriodDays(Integer.parseInt(data.get("noticePeriodDays").toString()));
  ...
  public RoiRegisterEntity addContractDetail(String registerId, Map<String, Object> data) {
    ...
    if (data.get("dateOfLastAudit") != null)
      detail.setDateOfLastAudit(java.time.LocalDate.parse((String) data.get("dateOfLastAudit")));
    if (data.get("exitPlanExists") != null)
      detail.setExitPlanExists(Boolean.parseBoolean(data.get("exitPlanExists").toString()));
  ...
  public RoiRegisterEntity addAssessment(String registerId, Map<String, Object> data) {
    ...
    if (data.get("assessmentDate") != null)
      assessment.setAssessmentDate(java.time.LocalDate.parse((String) data.get("assessmentDate")));
    assessment.setLevelOfReliance((String) data.get("levelOfReliance"));
    if (data.get("alternativeProvidersIdentified") != null)
      assessment.setAlternativeProvidersIdentified(
          Boolean.parseBoolean(data.get("alternativeProvidersIdentified").toString()));
    assessment.setSubstitutabilityAssessment((String) data.get("substitutabilityAssessment"));
    if (data.get("lastAuditDate") != null)
      assessment.setLastAuditDate(java.time.LocalDate.parse((String) data.get("lastAuditDate")));
    if (data.get("exitStrategyExists") != null)
      assessment.setExitStrategyExists(
          Boolean.parseBoolean(data.get("exitStrategyExists").toString()));
      ...
      for (RoiProviderEntity provider : register.getProviders()) {
        boolean alreadyLinked =
            register.getProviderSignings().stream()
                .anyMatch(
                    ps ->
                        ps.getContractRefNumber().equals(detail.getContractRefNumber())
