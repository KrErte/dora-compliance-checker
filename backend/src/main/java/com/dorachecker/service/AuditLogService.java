 ...
 * Logs admin operations, payment events, and auth events to a dedicated logger.
 */
@Service
public class AuditLogService {
    ...
    public void logAdminAction(String adminUser, String action, String targetUserId, String details) {
        audit.info("ADMIN action={} admin={} target={} details={}", action, adminUser, targetUserId, details);
    }
