...
public class IncidentReportService {
    ...
    public IncidentReportEntity create(String userId, Map<String, Object> body) {
        ...
        LocalDateTime detectedAt = detectedAtStr != null
            ? LocalDateTime.parse(detectedAtStr)
            : LocalDateTime.now();

        IncidentReportEntity entity = new IncidentReportEntity(userId, title, type, description, severity, detectedAt);

        // Classification criteria
        if (body.containsKey("clientsAffected")) entity.setClientsAffected(toInt(body.get("clientsAffected")));
        if (body.containsKey("transactionsAffected")) entity.setTransactionsAffected(toInt(body.get("transactionsAffected")));
        if (body.containsKey("geographicalSpread")) entity.setGeographicalSpread((String) body.get("geographicalSpread"));
        if (body.containsKey("dataLossType")) entity.setDataLossType((String) body.get("dataLossType"));
        if (body.containsKey("criticalServicesAffected")) entity.setCriticalServicesAffected((String) body.get("criticalServicesAffected"));
        if (body.containsKey("economicImpact")) entity.setEconomicImpact(toDouble(body.get("economicImpact")));
        if (body.containsKey("durationMinutes")) entity.setDurationMinutes(toInt(body.get("durationMinutes")));
        if (body.containsKey("reputationalImpact")) entity.setReputationalImpact((String) body.get("reputationalImpact"));
        if (body.containsKey("competentAuthority")) entity.setCompetentAuthority((String) body.get("competentAuthority"));
        if (body.containsKey("reportingContactName")) entity.setReportingContactName((String) body.get("reportingContactName"));
        if (body.containsKey("reportingContactEmail")) entity.setReportingContactEmail((String) body.get("reportingContactEmail"));
    ...
    public IncidentReportEntity submitInitialReport(String id, String userId, Map<String, Object> reportData) {
        IncidentReportEntity entity = getById(id, userId);
        if (entity == null) return null;
    ...
    public IncidentReportEntity submitIntermediateReport(String id, String userId, Map<String, Object> reportData) {
        IncidentReportEntity entity = getById(id, userId);
        if (entity == null) return null;
    ...
    public IncidentReportEntity submitFinalReport(String id, String userId, Map<String, Object> reportData) {
        IncidentReportEntity entity = getById(id, userId);
        if (entity == null) return null;
    ...
    public IncidentReportEntity resolve(String id, String userId, Map<String, Object> body) {
        ...
        if (body.containsKey("remediationActions")) entity.setRemediationActions((String) body.get("remediationActions"));
        if (body.containsKey("lessonsLearned")) entity.setLessonsLearned((String) body.get("lessonsLearned"));
        entity.calculateDeadlines();
        entity.setUpdatedAt(LocalDateTime.now());
        return repository.save(entity);
    }
    ...
    public IncidentReportEntity update(String id, String userId, Map<String, Object> body) {
        ...
        if (body.containsKey("incidentTitle")) entity.setIncidentTitle((String) body.get("incidentTitle"));
        ...
        if (body.containsKey("severityLevel")) entity.setSeverityLevel((String) body.get("severityLevel"));
        if (body.containsKey("clientsAffected")) entity.setClientsAffected(toInt(body.get("clientsAffected")));
        if (body.containsKey("transactionsAffected")) entity.setTransactionsAffected(toInt(body.get("transactionsAffected")));
        if (body.containsKey("geographicalSpread")) entity.setGeographicalSpread((String) body.get("geographicalSpread"));
        if (body.containsKey("dataLossType")) entity.setDataLossType((String) body.get("dataLossType"));
    ...
    public Map<String, Object> getStats(String userId) {
        ...
        long open = repository.countByUserIdAndReportingStatus(userId, "DETECTED")
        ...
        long closed = repository.countByUserIdAndReportingStatus(userId, "CLOSED")
    ...
    private boolean classifyAsMajor(IncidentReportEntity entity) {
        ...
        if (entity.getTransactionsAffected() != null && entity.getTransactionsAffected() > 1000) score++;
        ...
        if (entity.getCriticalServicesAffected() != null && !entity.getCriticalServicesAffected().isBlank()) score++;
