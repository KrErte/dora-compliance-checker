...
public class AiActDocumentService {
    ...
    public AiActDocumentService(AiActDocumentRepository documentRepository,
    ...
    @Transactional
    public AiActDocumentEntity startGeneration(String aiSystemId, String userId,
                                                 String documentType, String additionalContext) {
    ...
    @Async
    @Transactional
    public void generateContentAsync(String documentId, AiSystemEntity system,
                                      String documentType, String additionalContext) {
        try {
    ...
    @Transactional
    public Optional<AiActDocumentEntity> updateDocument(String documentId, String title, String content) {
