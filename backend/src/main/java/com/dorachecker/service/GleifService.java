...
public class GleifService {
  ...
  public Map<String, Object> lookupLei(String lei) {
    ...
    try {
      ...
      Map<String, Object> legalName =
          entity != null ? (Map<String, Object>) entity.get("legalName") : null;
      Map<String, Object> legalAddress =
          entity != null ? (Map<String, Object>) entity.get("legalAddress") : null;
          ...
          .map(
              record -> {
                ...
                Map<String, Object> entity =
                    attributes != null ? (Map<String, Object>) attributes.get("entity") : null;
                Map<String, Object> legalName2 =
                    entity != null ? (Map<String, Object>) entity.get("legalName") : null;
                Map<String, Object> legalAddress =
                    entity != null ? (Map<String, Object>) entity.get("legalAddress") : null;
