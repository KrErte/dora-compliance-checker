...
public class SampleContractService {
  ...
  public byte[] generateSamplePdf() {
    ...
    try (PdfWriter writer = new PdfWriter(baos);
      ...
      doc.add(
          new Paragraph("IKT-TEENUSE LEPING")
              .setFontSize(18)
              .setBold()
              .setTextAlignment(TextAlignment.CENTER));
      doc.add(
          new Paragraph("Leping nr: IKT-2025/001")
              .setFontSize(10)
              .setTextAlignment(TextAlignment.CENTER));
      doc.add(new Paragraph("\n"));

      doc.add(new Paragraph("1. LEPINGU POOLED").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n2. TEENUSE KIRJELDUS JA KVALITEET").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n3. ANDMETE TÖÖTLEMINE JA ASUKOHT").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n4. AUDITEERIMISÕIGUS").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n5. INTSIDENTIDEST TEAVITAMINE").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n6. TURVAMEETMED").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n7. ÄRIJÄTKUVUS").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n8. LEPINGU KEHTIVUS").setFontSize(14).setBold());
      doc.add(
          new Paragraph(
      ...
      doc.add(new Paragraph("\n\n"));
      doc.add(new Paragraph("Allkirjastatud digitaalselt 15.01.2025").setFontSize(10).setItalic());
