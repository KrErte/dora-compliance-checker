...
public class RegulatorPortalService {
  ...
  public RegulatorPortalService(
      RegulatorPortalTokenRepository tokenRepository, BoardPackageService boardPackageService) {
    this.tokenRepository = tokenRepository;
    this.boardPackageService = boardPackageService;
  }

  public RegulatorPortalTokenEntity createToken(
      String userId, String label, LocalDateTime expiresAt, String permissions) {
