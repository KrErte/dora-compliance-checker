...
public class DoraProportionalityRules {
  ...
  public static final Map<String, String> ENTITY_TYPES =
      Map.ofEntries(
  ...
  public static final Map<String, String> ENTITY_SECTORS =
      Map.ofEntries(
  ...
  public static List<ArticleApplicability> computeScope(
      ProportionalityClassificationEntity classification) {
    ...
    scope.add(
        new ArticleApplicability(
            "Art. 5-15",
            "ICT Risk Management Framework",
            micro ? "SIMPLIFIED" : "FULL",
            micro
                ? "Simplified framework under Art. 16 for micro entities"
                : "Full ICT risk management framework required"));
    ...
    scope.add(
        new ArticleApplicability(
            ...
            micro ? "FULL" : "EXEMPT",
            micro
                ? "Applies — simplified governance, no dedicated ICT officer required"
                : "Not applicable — entity is not micro-sized"));
    ...
    scope.add(
        new ArticleApplicability(
            ...
            significant
                ? "Required — entity is identified as significant by NCA"
                : "Not required — only for NCA-designated significant entities"));
  ...
  public static ProportionalityScope buildScope(
      ProportionalityClassificationEntity classification) {
