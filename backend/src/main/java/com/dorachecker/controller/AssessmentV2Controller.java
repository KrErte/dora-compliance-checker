...
public class AssessmentV2Controller {
  ...
  public AssessmentV2Controller(
      AssessmentEngineService assessmentEngineService, ActionPlanService actionPlanService) {
    this.assessmentEngineService = assessmentEngineService;
    this.actionPlanService = actionPlanService;
  }

  /** POST /api/v2/assessments Calculate assessment score and generate action plan. */
  @PostMapping
  public ResponseEntity<AssessmentResponse> calculateAssessment(
    ...
    try {
      AssessmentResult result =
          assessmentEngineService.calculateScore(request.regulationCode(), request.answers());
  ...
  public record AssessmentRequest(String regulationCode, Map<String, Integer> answers) {}
