...
public class CompanyLookupController {
  ...
  public record Nis2SectorDto(
      String sectorCode, String sectorNameEn, String sectorNameEt, String annexType) {}
  ...
  private static final Map<String, MockCompany> MOCK_COMPANIES =
      Map.of(
          "10000001",
              new MockCompany(
                  "10000001",
          ...
          "11066801",
              new MockCompany(
                  ...
                  "Tallinna Vesi AS",
                  "36.00",
                  "Vee kogumine, tootlemine ja jaotamine",
  ...
  public ResponseEntity<Nis2SectorDto> getEmtakNis2Mapping(@PathVariable String code) {
    return emtakService
        ...
        .orElse(ResponseEntity.ok(new Nis2SectorDto(null, null, null, "NOT_APPLICABLE")));
  }
