...
/**
 * REST API for pre-populated company profiles. Provides search, retrieval, and refresh
 * functionality for FI-licensed companies.
 */
@RestController
...
public class CompanyProfileController {
  ...
  public CompanyProfileController(
      CompanyProfileService profileService, CompanyProfileCrawlerService crawlerService) {
  ...
  /** Search companies by name or registry code GET /api/companies/search?q=Swedbank */
  @GetMapping("/search")
  ...
  /** Get company profile by registry code GET /api/companies/10060701 */
  ...
  public ResponseEntity<CompanyProfileEntity> getByRegistryCode(@PathVariable String registryCode) {
    ...
    return crawled.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
  }

  /** Get company profile by ID GET /api/companies/id/123 */
  @GetMapping("/id/{id}")
  ...
  /** Get all FI-licensed companies GET /api/companies/fi-licensed */
  ...
  /** Get companies by DORA tier GET /api/companies/tier/1 */
  ...
  /** Refresh company profile data from external sources POST /api/companies/10060701/refresh */
  ...
  public ResponseEntity<CompanyProfileEntity> refreshProfile(@PathVariable String registryCode) {
    Optional<CompanyProfileEntity> refreshed =
        profileService.refreshProfileByRegistryCode(registryCode);
    return refreshed.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
  }

  /** Refresh profile by ID POST /api/companies/id/123/refresh */
  ...
  /** Get crawl history for a company profile GET /api/companies/id/123/history */
  ...
  /** Get profile statistics GET /api/companies/stats */
  @GetMapping("/stats")
  ...
  /** Trigger full crawl (admin only) POST /api/companies/admin/crawl */
  ...
  /** Get crawler statistics GET /api/companies/admin/crawler-stats */
