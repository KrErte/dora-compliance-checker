...
public class VendorRiskController {
  ...
  public ResponseEntity<Map<String, Object>> getAllVendors(
    ...
    try {
      ...
      if (vendors.isEmpty()) {
        // Return mock data
        List<Map<String, Object>> filteredMock =
            filterMockVendors(category, riskLevel, search, sortBy, sortDir);
  ...
  public ResponseEntity<Map<String, Object>> getVendorDetail(@PathVariable String vendorName) {
    ...
    try {
      Optional<VendorRiskEntity> vendor =
          vendorRiskRepository.findByVendorNameIgnoreCase(vendorName);
  ...
  public ResponseEntity<Map<String, Object>> contributeVendorData(
      @RequestBody Map<String, Object> contribution) {
    ...
    response.put(
        "message",
        "Thank you for contributing! Your data will be reviewed and added to the database.");
    return ResponseEntity.ok(response);
  }

  private List<Map<String, Object>> filterMockVendors(
      String category, String riskLevel, String search, String sortBy, String sortDir) {
  ...
  private static List<Map<String, Object>> createMockVendors() {
    ...
    vendors.add(
        createVendor(
            ...
            80.0,
            55.0,
            "Subcontracting transparency, Data localization",
            "MEDIUM"));
    vendors.add(
        createVendor(
            "Microsoft Azure",
    ...
    vendors.add(
        createVendor(
            ...
            68.0,
            45.0,
            "Exit strategy, Incident notification",
            "HIGH"));
    vendors.add(
        createVendor(
            "PayPal",
  ...
  private static Map<String, Object> createVendor(
      String name,
      String category,
      int assessments,
      double avgScore,
