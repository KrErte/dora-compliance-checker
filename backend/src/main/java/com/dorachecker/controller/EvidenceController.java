...
public class EvidenceController {
    ...
    public ResponseEntity<?> upload(@RequestParam("file") MultipartFile file,
                                     ...
                                     Authentication auth) {
        try {
            EvidenceEntity entity = evidenceService.upload(getUserId(auth), file, title, category,
                pillar, description, expiryDate, articleNumbers);
    ...
    @GetMapping
    public ResponseEntity<?> list(@RequestParam(value = "pillar", required = false) String pillar,
    ...
    public ResponseEntity<?> verify(@PathVariable String id, @RequestBody Map<String, String> body,
                                     Authentication auth) {
    ...
    public ResponseEntity<?> uploadNewVersion(@PathVariable String id,
    ...
    public ResponseEntity<byte[]> exportZip(Authentication auth) {
        try {
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"evidence-vault-export.zip\"")
                .body(zipBytes);
        } catch (IOException e) {
