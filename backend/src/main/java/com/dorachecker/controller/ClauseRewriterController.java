...
public class ClauseRewriterController {
    ...
    @PostMapping("/rewrite")
    public ResponseEntity<Map<String, Object>> rewriteClause(@RequestBody Map<String, Object> request) {
    ...
    @PostMapping("/suggest")
    public ResponseEntity<Map<String, Object>> suggestClause(@RequestBody Map<String, Object> request) {
        String requirementType = (String) request.get("requirementType");
        String doraArticle = (String) request.get("doraArticle");
        String language = (String) request.getOrDefault("language", "et");
    ...
    private String buildSuggestionPrompt(String requirementType, String doraArticle, String context, String language) {
        ...
        return """
                ...
                """.formatted(doraArticle, requirementType, context.isBlank() ? "General ICT service contract" : context, lang);
    }
    ...
    private Map<String, Object> getMockResponse(String requirementType, String language) {
        ...
        String clauseTemplate = switch (requirementType != null ? requirementType : "") {
            case "AUDIT" -> isEt
    ...
    private Map<String, Object> getMockSuggestion(String requirementType, String language) {
        ...
        String clause = switch (requirementType != null ? requirementType : "") {
            case "AUDIT" -> isEt
                ? """
                    AUDITEERIMISÕIGUS
        ...
        response.put("keyElements", List.of(
            ...
            isEt ? "Regulatiivsete asutuste õigused on tagatud" : "Regulatory authority rights are ensured",
            isEt ? "Kulude jaotus on selge" : "Cost allocation is clear"
        ));
        response.put("legalReferences", List.of("DORA Art. 30(2)(c)", "DORA Art. 30(3)(a)"));
        response.put("implementationNotes", isEt
