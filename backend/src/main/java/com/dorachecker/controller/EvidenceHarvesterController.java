...
public class EvidenceHarvesterController {
    ...
    public ResponseEntity<?> saveConnector(Authentication auth, @RequestBody Map<String, String> body) {
        String userId = (String) auth.getPrincipal();
        ...
        HarvesterConnectorEntity saved = harvesterService.saveConnector(userId, connectorType, displayName, configJson, mappingRulesJson);
