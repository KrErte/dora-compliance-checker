...
public class ScheduledReportController {
    ...
    public ResponseEntity<?> update(@PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
        ...
        return repository.findById(id)
                ...
                .map(entity -> {
                    if (body.containsKey("reportType")) entity.setReportType((String) body.get("reportType"));
                    if (body.containsKey("frequency")) entity.setFrequency((String) body.get("frequency"));
                    if (body.containsKey("dayOfWeek")) entity.setDayOfWeek((Integer) body.get("dayOfWeek"));
                    if (body.containsKey("dayOfMonth")) entity.setDayOfMonth((Integer) body.get("dayOfMonth"));
                    if (body.containsKey("recipients")) entity.setRecipients((String) body.get("recipients"));
