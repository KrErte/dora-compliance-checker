...
public class RoiExportController {
    ...
    public RoiExportController(RoiXbrlCsvService xbrlCsvService, SubscriptionGuardService guardService) {
    ...
    public ResponseEntity<?> exportXbrlCsv(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Map.of(
                "error", "EXPORT_FAILED",
                "message", "xBRL-CSV genereerimine ebaõnnestus: " + e.getMessage()
            ));
        }
    }
