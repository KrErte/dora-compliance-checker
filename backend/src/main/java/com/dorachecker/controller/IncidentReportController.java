...
public class IncidentReportController {
  ...
  @PostMapping
  public ResponseEntity<IncidentReportEntity> create(
  ...
  @GetMapping("/{id}")
  public ResponseEntity<IncidentReportEntity> getById(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<IncidentReportEntity> update(
  ...
  public ResponseEntity<IncidentReportEntity> classify(
      @PathVariable String id, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> submitInitialReport(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> submitIntermediateReport(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
    IncidentReportEntity entity =
        incidentService.submitIntermediateReport(id, getUserId(auth), body);
    if (entity == null) return ResponseEntity.notFound().build();
    return ResponseEntity.ok(entity);
  }

  @PostMapping("/{id}/final-report")
  public ResponseEntity<IncidentReportEntity> submitFinalReport(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> resolve(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> activateWarRoom(
      @PathVariable String id, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> closeWarRoom(
      @PathVariable String id, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> addCommunication(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> addDecision(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> updatePhase(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
  ...
  public ResponseEntity<IncidentReportEntity> updateRoles(
      @PathVariable String id, @RequestBody Map<String, Object> body, Authentication auth) {
    try {
      String rolesJson =
          new com.fasterxml.jackson.databind.ObjectMapper().writeValueAsString(body.get("roles"));
      IncidentReportEntity entity =
          incidentService.updateWarRoomRoles(id, getUserId(auth), rolesJson);
      if (entity == null) return ResponseEntity.notFound().build();
      return ResponseEntity.ok(entity);
    } catch (Exception e) {
      return ResponseEntity.badRequest().build();
