...
public class AiActClassificationController {
    ...
    public ResponseEntity<?> getQuestions(Authentication authentication) {
        ...
        var dtos = questions.stream().map(q -> new QuestionDto(
            q.getId(), q.getQuestionKey(), q.getQuestionTextEn(), q.getQuestionTextEt(),
            q.getQuestionType(), q.getOptions(), q.getCategory(),
            q.getHelpTextEn(), q.getHelpTextEt(), q.getSortOrder(),
            q.getDependsOnKey(), q.getDependsOnAnswer()
        )).toList();
    ...
    public record QuestionDto(
        String id, String questionKey, String questionTextEn, String questionTextEt,
        String questionType, String options, String category,
        String helpTextEn, String helpTextEt, int sortOrder,
