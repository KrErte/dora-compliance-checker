...
public class PolicyWriterController {
    ...
    public PolicyWriterController(PolicyWriterService policyWriterService,
    ...
    public ResponseEntity<?> list(Authentication authentication) {
        ...
        List<Map<String, Object>> summaries = policies.stream().map(p -> {
    ...
    public ResponseEntity<?> getById(@PathVariable String id, Authentication authentication) {
        ...
        return policyWriterService.getById(id)
