...
public class UserAlertController {
            ...
            .map(
                a -> {
                  RegulatoryUpdateEntity update =
                      alertService.getRegulatoryUpdate(a.getRegulatoryUpdateId()).orElse(null);
  ...
  public ResponseEntity<AlertDetailResponse> getAlertDetail(
    ...
    return alertService
        ...
        .map(
            alert -> {
              RegulatoryUpdateEntity update =
                  alertService.getRegulatoryUpdate(alert.getRegulatoryUpdateId()).orElse(null);
  ...
  private AlertDetailResponse toAlertDetailResponse(
      UserAlertEntity alert, RegulatoryUpdateEntity update) {
    return new AlertDetailResponse(
        ...
        update != null && update.getPublishedDate() != null
            ? update.getPublishedDate().toString()
            : null);
  }
