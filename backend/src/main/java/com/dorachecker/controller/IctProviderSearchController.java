...
/**
 * Alternative endpoint for ICT provider search Maps /api/ict-providers/search as specified in DORA
 * API docs
 */
@RestController
...
public class IctProviderSearchController {
  ...
  /**
   * GET /api/ict-providers/search?q=nortal&country=EE&type=IT_CONSULTING Case-insensitive, partial
   * match, max 20 results Sorted: is_ctpp DESC, name ASC
   */
  @GetMapping("/search")
