...
public class GuardianController {
  ...
  @PostMapping("/monitor")
  public ResponseEntity<MonitoredContractEntity> startMonitoring(
    ...
    MonitoredContractEntity result =
        monitoredContractService.startMonitoring(analysisId, contractText, getUserId(auth));
  ...
  public ResponseEntity<RegulatoryUpdateEntity> addRegulatoryUpdate(
      @RequestBody Map<String, String> body, Authentication auth) {
    // Admin-only — enforced via SecurityConfig
