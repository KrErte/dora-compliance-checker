...
public class RegulatoryTranslatorController {
  ...
  public RegulatoryTranslatorController(
      RegulatoryTranslatorService translatorService, SubscriptionGuardService subscriptionGuard) {
  ...
  public ResponseEntity<?> getUpdatesWithStatus(
    ...
    return ResponseEntity.ok(
        translatorService.getUpdatesWithTranslationStatus(getUserId(auth), page, size));
  }
  ...
  public ResponseEntity<?> applyActionItems(
