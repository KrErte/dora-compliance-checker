...
public class RoiIntraGroupContractEntity {
    ...
    public String getProviderEntityLei() { return providerEntityLei; }
    public void setProviderEntityLei(String providerEntityLei) { this.providerEntityLei = providerEntityLei; }
    public String getReceiverEntityLei() { return receiverEntityLei; }
    public void setReceiverEntityLei(String receiverEntityLei) { this.receiverEntityLei = receiverEntityLei; }
}
