...
@Entity
@Table(name = "harvester_connectors", indexes = {
    @Index(name = "idx_harvester_connector_user_id", columnList = "userId")
})
public class HarvesterConnectorEntity {
    ...
    private String connectorType; // JIRA, GITHUB, AZURE_DEVOPS, AWS_CLOUDTRAIL, SLACK, CONFLUENCE, GOOGLE_DRIVE
    ...
    public LocalDateTime getLastHarvestAt() { return lastHarvestAt; }
    public void setLastHarvestAt(LocalDateTime lastHarvestAt) { this.lastHarvestAt = lastHarvestAt; }
