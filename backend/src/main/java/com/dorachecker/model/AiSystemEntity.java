...
public class AiSystemEntity {
    ...
    private String complianceStatus = "NOT_STARTED"; // NOT_STARTED, IN_PROGRESS, COMPLIANT, NON_COMPLIANT
    ...
    public String getDeploymentContext() { return deploymentContext; }
    public void setDeploymentContext(String deploymentContext) { this.deploymentContext = deploymentContext; }
    ...
    public String getClassifiedByUserId() { return classifiedByUserId; }
    public void setClassifiedByUserId(String classifiedByUserId) { this.classifiedByUserId = classifiedByUserId; }
