...
/**
 * JPA entity for compliance questions within a domain. Supports multi-language (Estonian/English)
...
public class ComplianceQuestionEntity {
  ...
  public ComplianceDomainEntity getDomain() {
    return domain;
  }

  public void setDomain(ComplianceDomainEntity domain) {
    this.domain = domain;
  }
  ...
  public void setQuestionEt(String questionEt) {
    this.questionEt = questionEt;
  }
  ...
  public void setGuidanceEn(String guidanceEn) {
    this.guidanceEn = guidanceEn;
  }

  public String getGuidanceEt() {
    return guidanceEt;
  }

  public void setGuidanceEt(String guidanceEt) {
    this.guidanceEt = guidanceEt;
  }
  ...
  public String getRecommendationEt() {
    return recommendationEt;
  }

  public void setRecommendationEt(String recommendationEt) {
    this.recommendationEt = recommendationEt;
  }
