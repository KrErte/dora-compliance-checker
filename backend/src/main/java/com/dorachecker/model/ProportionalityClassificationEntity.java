...
public class ProportionalityClassificationEntity {
    ...
    public int getIctSystemCount() { return ictSystemCount; }
    public void setIctSystemCount(int ictSystemCount) { this.ictSystemCount = ictSystemCount; }

    public boolean isCrossBorderOperations() { return crossBorderOperations; }
    public void setCrossBorderOperations(boolean crossBorderOperations) { this.crossBorderOperations = crossBorderOperations; }
    ...
    public boolean isNcaDesignated() { return ncaDesignated; }
    public void setNcaDesignated(boolean ncaDesignated) { this.ncaDesignated = ncaDesignated; }

    public boolean isSimplifiedRegime() { return simplifiedRegime; }
    public void setSimplifiedRegime(boolean simplifiedRegime) { this.simplifiedRegime = simplifiedRegime; }
