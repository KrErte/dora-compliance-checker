...
@Entity
@Table(
    name = "monitored_contracts",
    indexes = {@Index(name = "idx_monitored_contracts_user_id", columnList = "userId")})
public class MonitoredContractEntity {
  ...
  public String getContractAnalysisId() {
    return contractAnalysisId;
  }

  public void setContractAnalysisId(String contractAnalysisId) {
    this.contractAnalysisId = contractAnalysisId;
  }
  ...
  public String getLastAnalysisId() {
    return lastAnalysisId;
  }

  public void setLastAnalysisId(String lastAnalysisId) {
