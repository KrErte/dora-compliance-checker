...
public class CompanyProfileEntity {
    ...
    public String getEmtakDescription() { return emtakDescription; }
    public void setEmtakDescription(String emtakDescription) { this.emtakDescription = emtakDescription; }

    public Integer getEmployeeCount() { return employeeCount; }
    public void setEmployeeCount(Integer employeeCount) { this.employeeCount = employeeCount; }

    public BigDecimal getRevenueEur() { return revenueEur; }
    public void setRevenueEur(BigDecimal revenueEur) { this.revenueEur = revenueEur; }
    ...
    public String getFiLicenseType() { return fiLicenseType; }
    public void setFiLicenseType(String fiLicenseType) { this.fiLicenseType = fiLicenseType; }

    public LocalDate getFiLicenseDate() { return fiLicenseDate; }
    public void setFiLicenseDate(LocalDate fiLicenseDate) { this.fiLicenseDate = fiLicenseDate; }

    public String getFiLicenseStatus() { return fiLicenseStatus; }
    public void setFiLicenseStatus(String fiLicenseStatus) { this.fiLicenseStatus = fiLicenseStatus; }

    public Integer getDoraTier() { return doraTier; }
    public void setDoraTier(Integer doraTier) { this.doraTier = doraTier; }

    public Integer getSslValidDays() { return sslValidDays; }
    public void setSslValidDays(Integer sslValidDays) { this.sslValidDays = sslValidDays; }
    ...
    public Integer getSecurityHeadersScore() { return securityHeadersScore; }
    public void setSecurityHeadersScore(Integer securityHeadersScore) { this.securityHeadersScore = securityHeadersScore; }

    public String getSecurityHeadersDetails() { return securityHeadersDetails; }
    public void setSecurityHeadersDetails(String securityHeadersDetails) { this.securityHeadersDetails = securityHeadersDetails; }

    public Boolean getSpfRecordExists() { return spfRecordExists; }
    public void setSpfRecordExists(Boolean spfRecordExists) { this.spfRecordExists = spfRecordExists; }

    public Boolean getDmarcRecordExists() { return dmarcRecordExists; }
    public void setDmarcRecordExists(Boolean dmarcRecordExists) { this.dmarcRecordExists = dmarcRecordExists; }
    ...
    public Boolean getHttpsRedirect() { return httpsRedirect; }
    public void setHttpsRedirect(Boolean httpsRedirect) { this.httpsRedirect = httpsRedirect; }

    public Integer getDigitalRiskScore() { return digitalRiskScore; }
    public void setDigitalRiskScore(Integer digitalRiskScore) { this.digitalRiskScore = digitalRiskScore; }
    ...
    public String getGroupStructure() { return groupStructure; }
    public void setGroupStructure(String groupStructure) { this.groupStructure = groupStructure; }
