...
public class RoiFunctionEntity {
  ...
  public String getLicensedActivity() {
    return licensedActivity;
  }

  public void setLicensedActivity(String licensedActivity) {
    this.licensedActivity = licensedActivity;
  }
  ...
  public String getCriticalityAssessment() {
    return criticalityAssessment;
  }

  public void setCriticalityAssessment(String criticalityAssessment) {
    this.criticalityAssessment = criticalityAssessment;
  }

  public String getReasonsForCriticality() {
    return reasonsForCriticality;
  }

  public void setReasonsForCriticality(String reasonsForCriticality) {
