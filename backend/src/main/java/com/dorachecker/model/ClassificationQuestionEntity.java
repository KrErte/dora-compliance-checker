...
public class ClassificationQuestionEntity {
    ...
    public String getQuestionTextEt() { return questionTextEt; }
    public void setQuestionTextEt(String questionTextEt) { this.questionTextEt = questionTextEt; }
    ...
    public String getHelpTextEn() { return helpTextEn; }
    public void setHelpTextEn(String helpTextEn) { this.helpTextEn = helpTextEn; }

    public String getHelpTextEt() { return helpTextEt; }
    public void setHelpTextEt(String helpTextEt) { this.helpTextEt = helpTextEt; }
    ...
    public String getDependsOnAnswer() { return dependsOnAnswer; }
    public void setDependsOnAnswer(String dependsOnAnswer) { this.dependsOnAnswer = dependsOnAnswer; }
