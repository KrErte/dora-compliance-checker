...
@Table(
    ...
    indexes = {@Index(name = "idx_contract_alerts_user_id", columnList = "userId")})
public class ContractAlertEntity {
  ...
  public String getMonitoredContractId() {
    return monitoredContractId;
  }

  public void setMonitoredContractId(String monitoredContractId) {
    this.monitoredContractId = monitoredContractId;
  }
