...
@Entity
@Table(
    name = "ict_service_arrangements",
    indexes = {@Index(name = "idx_ict_providers_user_id", columnList = "user_id")})
public class IctProviderEntity {
  ...
  public String getSubcontractingInfo() {
    return subcontractingInfo;
  }

  public void setSubcontractingInfo(String subcontractingInfo) {
    this.subcontractingInfo = subcontractingInfo;
  }

  public String getExitStrategyStatus() {
    return exitStrategyStatus;
  }

  public void setExitStrategyStatus(String exitStrategyStatus) {
  ...
  public void setLastAssessmentDate(LocalDate lastAssessmentDate) {
  ...
  public Boolean getHasExitStrategy() {
    return hasExitStrategy;
  }

  public void setHasExitStrategy(Boolean hasExitStrategy) {
    this.hasExitStrategy = hasExitStrategy;
  }
  ...
  public String getCriticalityReason() {
    return criticalityReason;
  }

  public void setCriticalityReason(String criticalityReason) {
    this.criticalityReason = criticalityReason;
  }
