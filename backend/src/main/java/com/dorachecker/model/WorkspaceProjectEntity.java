...
public class WorkspaceProjectEntity {
  ...
  @Column private String teamId; // for collaborative features
  ...
  public List<WorkspaceDocumentEntity> getDocuments() {
    return documents;
  }

  public void setDocuments(List<WorkspaceDocumentEntity> documents) {
    this.documents = documents;
  }

  public List<WorkspaceGapResultEntity> getGapResults() {
    return gapResults;
  }

  public void setGapResults(List<WorkspaceGapResultEntity> gapResults) {
    this.gapResults = gapResults;
  }

  public List<WorkspaceReviewEntity> getReviews() {
    return reviews;
  }

  public void setReviews(List<WorkspaceReviewEntity> reviews) {
    this.reviews = reviews;
  }

  public List<WorkspaceAuditLogEntity> getAuditLogs() {
    return auditLogs;
  }

  public void setAuditLogs(List<WorkspaceAuditLogEntity> auditLogs) {
