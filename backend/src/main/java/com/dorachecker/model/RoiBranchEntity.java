...
public class RoiBranchEntity {
    ...
    public String getBranchIdentifier() { return branchIdentifier; }
    public void setBranchIdentifier(String branchIdentifier) { this.branchIdentifier = branchIdentifier; }
    public String getEntityLei() { return entityLei; }
    public void setEntityLei(String entityLei) { this.entityLei = entityLei; }
    public String getCountryOfBranch() { return countryOfBranch; }
    public void setCountryOfBranch(String countryOfBranch) { this.countryOfBranch = countryOfBranch; }
    ...
    public String getBranchIdentificationCode() { return branchIdentificationCode; }
    public void setBranchIdentificationCode(String branchIdentificationCode) { this.branchIdentificationCode = branchIdentificationCode; }
}
