...
public class RoiValidationResultEntity {
    ...
    public String getCompletenessJson() { return completenessJson; }
    public void setCompletenessJson(String completenessJson) { this.completenessJson = completenessJson; }
}
