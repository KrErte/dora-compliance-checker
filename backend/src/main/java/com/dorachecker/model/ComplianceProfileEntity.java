...
public class ComplianceProfileEntity {
    ...
    public enum CompanyType {
        BANK, FINTECH, INSURANCE, INVESTMENT_FIRM, ICT_PROVIDER, OTHER
    }
    ...
    public boolean isAlertEmail() { return alertEmail; }
    public void setAlertEmail(boolean alertEmail) { this.alertEmail = alertEmail; }
    public boolean isAlertDashboard() { return alertDashboard; }
    public void setAlertDashboard(boolean alertDashboard) { this.alertDashboard = alertDashboard; }
