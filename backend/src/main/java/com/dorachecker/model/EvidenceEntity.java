...
@Entity
@Table(name = "evidence_items", indexes = {
...
public class EvidenceEntity {
    ...
    @Column(nullable = false)
    private String category; // POLICY, PROCEDURE, TEST_REPORT, TRAINING_CERTIFICATE, CONTRACT, MEETING_MINUTES, AUDIT_REPORT, RISK_ASSESSMENT, OTHER

    @Column(nullable = false)
    private String pillar; // ICT_RISK_MANAGEMENT, INCIDENT_MANAGEMENT, TESTING, THIRD_PARTY, INFORMATION_SHARING
    ...
    public EvidenceEntity(String userId, String title, String category, String pillar, String fileName, String storedFileName) {
        this.userId = userId;
        this.title = title;
