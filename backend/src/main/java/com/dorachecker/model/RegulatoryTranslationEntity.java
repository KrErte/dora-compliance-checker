...
@Entity
@Table(name = "regulatory_translations", indexes = {
...
public class RegulatoryTranslationEntity {
    ...
    @Column(columnDefinition = "TEXT")
    private String affectedAreasJson; // JSON: assessmentGaps, evidenceGaps, affectedProviders, contractClauses
    ...
    public Integer getPersonalImpactScore() { return personalImpactScore; }
    public void setPersonalImpactScore(Integer personalImpactScore) { this.personalImpactScore = personalImpactScore; }
    ...
    public String getAffectedAreasJson() { return affectedAreasJson; }
    public void setAffectedAreasJson(String affectedAreasJson) { this.affectedAreasJson = affectedAreasJson; }
    ...
    public Double getAssessmentScoreAtTime() { return assessmentScoreAtTime; }
    public void setAssessmentScoreAtTime(Double assessmentScoreAtTime) { this.assessmentScoreAtTime = assessmentScoreAtTime; }
    public Long getEvidenceCountAtTime() { return evidenceCountAtTime; }
    public void setEvidenceCountAtTime(Long evidenceCountAtTime) { this.evidenceCountAtTime = evidenceCountAtTime; }
    public Long getProviderCountAtTime() { return providerCountAtTime; }
    public void setProviderCountAtTime(Long providerCountAtTime) { this.providerCountAtTime = providerCountAtTime; }
    public Long getContractCountAtTime() { return contractCountAtTime; }
    public void setContractCountAtTime(Long contractCountAtTime) { this.contractCountAtTime = contractCountAtTime; }
    ...
    public int getAppliedActionItems() { return appliedActionItems; }
    public void setAppliedActionItems(int appliedActionItems) { this.appliedActionItems = appliedActionItems; }
