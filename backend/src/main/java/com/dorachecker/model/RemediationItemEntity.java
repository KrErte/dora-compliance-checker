...
@Entity
@Table(name = "remediation_items", indexes = {
...
public class RemediationItemEntity {
    ...
    public RemediationItemEntity(String userId, String title, String description,
                                  String source, String sourceId, String pillar,
                                  String articleReference, String priority) {
        this.userId = userId;
        this.title = title;
