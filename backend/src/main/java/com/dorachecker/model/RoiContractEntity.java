...
public class RoiContractEntity {
    ...
    public String getOverarchingRefNumber() { return overarchingRefNumber; }
    public void setOverarchingRefNumber(String overarchingRefNumber) { this.overarchingRefNumber = overarchingRefNumber; }
    ...
    public String getReasonForCriticality() { return reasonForCriticality; }
    public void setReasonForCriticality(String reasonForCriticality) { this.reasonForCriticality = reasonForCriticality; }
}
