...
@Entity
@Table(name = "sso_configs", indexes = {
    @Index(name = "idx_sso_configs_org_id", columnList = "organizationId")
})
public class SsoConfigEntity {

    public enum SsoType { SAML2, OIDC }
    public enum SsoStatus { DRAFT, ACTIVE, DISABLED }
    ...
    public SsoType getType() { return type; }
    public void setType(SsoType type) { this.type = type; }
    public SsoStatus getStatus() { return status; }
    public void setStatus(SsoStatus status) { this.status = status; }
