...
/**
 * JPA entity for compliance domains/categories within a regulation. E.g., for DORA: ICT Risk
 * Management, Incident Management, Testing, etc. E.g., for NIS2: Risk Analysis, Incident Handling,
...
public class ComplianceDomainEntity {
  ...
  public ComplianceDomainEntity(
      RegulationEntity regulation, String code, String nameEn, String nameEt, int displayOrder) {
  ...
  public List<ComplianceQuestionEntity> getQuestions() {
    return questions;
  }

  public void setQuestions(List<ComplianceQuestionEntity> questions) {
