...
public class RoiProviderEntity {
  ...
  public String getCurrencyOfContract() {
    return currencyOfContract;
  }

  public void setCurrencyOfContract(String currencyOfContract) {
    this.currencyOfContract = currencyOfContract;
  }

  public BigDecimal getTotalAnnualSpend() {
    return totalAnnualSpend;
  }

  public void setTotalAnnualSpend(BigDecimal totalAnnualSpend) {
    this.totalAnnualSpend = totalAnnualSpend;
  }

  public String getUltimateParentLei() {
    return ultimateParentLei;
  }

  public void setUltimateParentLei(String ultimateParentLei) {
  ...
  public String getUltimateParentCountry() {
    return ultimateParentCountry;
  }

  public void setUltimateParentCountry(String ultimateParentCountry) {
    this.ultimateParentCountry = ultimateParentCountry;
  }
}
